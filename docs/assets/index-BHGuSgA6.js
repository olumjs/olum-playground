...
`}`,olum.injectStyle(`Anchor`,x.__style__()),olum.handleMarkup(`Anchor`,`hfitusuuzw8`,e,b)}};return{methods:x.methods,props:x.props,__OLUM__:x,el:y,methodsRef:b,stateProps:null,localsRef:{get base(){return m},get variants(){return h},get sizes(){return g}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Y=e=>{let t=e||`Icon`,n=d(t),{icon:r,class:i=``}=d(t),a=()=>q(`inline-flex items-center justify-center`,`[&_svg]:w-full [&_svg]:h-full [&_svg]:text-current [&_svg]:stroke-current`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`Icon`,`s74ha1l51j`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`Icon`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
  ...
  ${m().map(function(e){return`
    <div data-slot="toast" class="pointer-events-auto col-start-1 row-start-1 flex items-center gap-3 rounded-2xl border border-border bg-background p-4 text-sm text-foreground shadow-lg transition-all duration-300 ease-out" style="${olum.esc(g(e))}" key="${olum.esc(e.id)}">
      ...
      <button type="button" aria-label="Close toast" class="relative flex size-6 shrink-0 items-center justify-center rounded-md text-muted-foreground hover:bg-muted hover:text-foreground" data-o-event='onclick|__olumAnon_xmjtx54=${JSON.stringify([`$event`,e])}'>
...
</div>`,olum.injectStyle(`DemoPanel`,m.__style__()),olum.handleMarkup(`DemoPanel`,`9syq125690s`,e,p)}};return s.__olum__={compName:t,compId:`9syq125690s`},s=olum.proxyHandler(s,null,f),{methods:m.methods,props:m.props,__OLUM__:m,el:f,methodsRef:p,stateProps:s,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},mt=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg>`,ht=e=>{let t=e||`WhatsHappening`,n=d(t),{items:r}=d(t);var i=olum.mkElm(`div`,`WhatsHappening`,`2w9i6jvpgim`),a={},o={__style__(){return``},methods:{},props:{},compName:`WhatsHappening`,deps:null,components:{Icon:Y},get getElm(){var e=i.isConnected?olum.vdom.mkStaging(i):i;return e.innerHTML=`
...
<span class="text-muted-foreground">// selects flip an "selected" attribute per &lt;option&gt;.</span>`,consoleLines:n.log})).replace(/'/g,`%27`)}' data-o-props-src="consoleLines:state:log" data-o-props-owner='${t}'>
  ...
  <div class="mt-10 grid grid-cols-1 gap-8 lg:grid-cols-2">
    <form class="flex flex-col gap-5 rounded-xl border border-border p-6" data-o-event='onsubmit|__olumAnon_aq37y1n=${JSON.stringify([`$event`])}'>
      <label class="flex flex-col gap-1.5 text-sm">
        <span class="font-medium text-foreground">Textarea</span>
        <textarea rows="3" placeholder="a longer answer" class="rounded-lg border border-border bg-background px-3 py-2 outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50" data-o-event='oninput|__olumAnon_a465upd=${JSON.stringify([`$event`])}'>${olum.esc(n.bio)}</textarea>
      </label>

      <label class="flex flex-col gap-1.5 text-sm">
        <span class="font-medium text-foreground">Number (cast with +)</span>
        <input type="number" value="${olum.esc(n.n)}" class="h-9 w-32 rounded-lg border border-border bg-background px-3 outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50" data-o-event='oninput|__olumAnon_n9tn08o=${JSON.stringify([`$event`])}'>
      </label>

      <label class="flex items-center gap-2 text-sm">
        <input type="checkbox" ${n.agree?`checked`:``} class="size-4 rounded border-border" data-o-event='onchange|__olumAnon_7378liw=${JSON.stringify([`$event`])}'>
      ...
      <label class="flex flex-col gap-1.5 text-sm">
        ...
        <select class="h-9 rounded-lg border border-border bg-background px-3" data-o-event='onchange|__olumAnon_mbmjovg=${JSON.stringify([`$event`])}'>
...
<olum name="SiteFooter"></olum>`,olum.injectStyle(`page`,a.__style__()),olum.handleMarkup(`page`,`lsoyy77dgul`,e,i)}};return{methods:a.methods,props:a.props,__OLUM__:a,el:r,methodsRef:i,stateProps:null,localsRef:{get happening(){return t},get loveItems(){return n}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Bt=e=>{let t=e||`StatusBadge`,n=d(t),{label:r,color:i=`#16a34a`}=d(t);var a=olum.mkElm(`div`,`StatusBadge`,`qcp8hfhjf3f`),o={},s={__style__(){return``},methods:{},props:{},compName:`StatusBadge`,deps:null,components:{},get getElm(){var e=a.isConnected?olum.vdom.mkStaging(a):a;return e.innerHTML=`
  ...
  ${olum.esc(n.label)}
</span>`,olum.injectStyle(`StatusBadge`,s.__style__()),olum.handleMarkup(`StatusBadge`,`qcp8hfhjf3f`,e,o)}};return{methods:s.methods,props:s.props,__OLUM__:s,el:a,methodsRef:o,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Vt=e=>{let t=e||`CounterCard`,n=d(t),{value:r,onChange:i}=d(t),a=()=>n.onChange(n.value+1);var o=olum.mkElm(`div`,`CounterCard`,`md733pi0m29`),s={bump:a},c={__style__(){return``},methods:{bump:a},props:{},compName:`CounterCard`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
...
</div>`,olum.injectStyle(`CounterCard`,c.__style__()),olum.handleMarkup(`CounterCard`,`md733pi0m29`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ht=e=>{let t=e||`Box`,n=d(t),{children:r}=d(t);var i=olum.mkElm(`div`,`Box`,`opjl93p2j5b`),a={},o={__style__(){return``},methods:{},props:{},compName:`Box`,deps:null,components:{},get getElm(){var e=i.isConnected?olum.vdom.mkStaging(i):i;return e.innerHTML=`
    ...
    <div class="grid grid-cols-1 gap-6 rounded-xl border border-border p-6 md:grid-cols-2">
      <div>
        ...
        <div data-o-show="" style="display:${n.showOpen?`contents`:`none`};">
          <input value="${olum.esc(n.showText)}" placeholder="Type, then hide/show…" class="h-8 w-full rounded-md border border-border bg-background px-2.5 text-sm outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50" data-o-event='oninput|__olumAnon_bqi9fqi=${JSON.stringify([`$event`])}'>
        </div>
      </div>
      <div>
        <div class="mb-2 flex items-center justify-between">
        ...
        ${n.ifOpen?`
          <input value="${olum.esc(n.ifText)}" placeholder="Type, then remove/add…" class="h-8 w-full rounded-md border border-border bg-background px-2.5 text-sm outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50" data-o-event='oninput|__olumAnon_tnb5i65=${JSON.stringify([`$event`])}'>
        `:``}
      </div>
    </div>
  </section>
...
<olum name="SiteFooter"></olum>`,olum.injectStyle(`page`,C.__style__()),olum.handleMarkup(`page`,`73a3pv1ju1l`,e,S)}};return n.__olum__={compName:t,compId:`73a3pv1ju1l`},n=olum.proxyHandler(n,null,x),{methods:C.methods,props:C.props,__OLUM__:C,el:x,methodsRef:S,stateProps:n,localsRef:{get btn(){return p},get btnActive(){return m},get happening(){return h},get loveItems(){return g}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},en=e=>{let t=e||`LifecycleLogger`,n=d(t),{onLog:r}=d(t);var i=o(()=>(n.onLog(`mounted`),()=>n.onLog(`unmounted`))),a=olum.mkElm(`div`,`LifecycleLogger`,`wdpp8gxzga`),s={},c={__style__(){return``},methods:{},props:{},compName:`LifecycleLogger`,deps:null,components:{},get getElm(){var e=a.isConnected?olum.vdom.mkStaging(a):a;return e.innerHTML=`
...
<olum name="SiteFooter"></olum>`,olum.injectStyle(`page`,f.__style__()),olum.handleMarkup(`page`,`fvx4ahb70it`,e,d)}};return n.__olum__={compName:t,compId:`fvx4ahb70it`},n=olum.proxyHandler(n,null,l),{methods:f.methods,props:f.props,__OLUM__:f,el:l,methodsRef:d,stateProps:n,localsRef:{get happening(){return s},get loveItems(){return c}},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},sn=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M12 8v4m0 4h.01"/></svg>`,cn=e=>{var t=olum.mkElm(`div`,`not-found`,`v7pjvse8iaj`),n={},r={__style__(){return``},methods:{},props:{},compName:`not-found`,deps:null,components:{Nav:X,SiteFooter:Q,Anchor:Ye,Icon:Y},get getElm(){var e=t.isConnected?olum.vdom.mkStaging(t):t;return e.innerHTML=`
      <olum name="Nav"></olum>
...
<olum name="SiteFooter"></olum>`,olum.injectStyle(`page`,S.__style__()),olum.handleMarkup(`page`,`af45iqt48cb`,e,x)}};return n.__olum__={compName:t,compId:`af45iqt48cb`},n=olum.proxyHandler(n,c,b),{methods:S.methods,props:S.props,__OLUM__:S,el:b,methodsRef:x,stateProps:n,localsRef:{get happening(){return m},get loveItems(){return h}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Tn=e=>{let t=e||`CardContent`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`px-(--card-spacing)`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`CardContent`,`1t41fcy85yah`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`CardContent`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="card-content" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`CardContent`,c.__style__()),olum.handleMarkup(`CardContent`,`1t41fcy85yah`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},$=f({items:[],add(e){let t=this.items.find(t=>t.id===e.id);t?t.qty++:this.items=[...this.items,{...e,qty:1}]},inc(e){let t=this.items.find(t=>t.id===e);t&&t.qty++},dec(e){let t=this.items.find(t=>t.id===e);t&&(t.qty<=1?this.remove(e):t.qty--)},remove(e){this.items=this.items.filter(t=>t.id!==e)},clear(){this.items=[]}}),En=()=>$.items.reduce((e,t)=>e+t.qty,0),Dn=()=>$.items.reduce((e,t)=>e+t.qty*t.price,0),On=e=>{let t=e||`ProductList`,n=[{id:`p1`,name:`Fade Cushion`,price:24},{id:`p2`,name:`Fly Lamp`,price:58},{id:`p3`,name:`Slide Rug`,price:132},{id:`p4`,name:`Crossfade Mug`,price:14},{id:`p5`,name:`Flip Frame`,price:39},{id:`p6`,name:`Draw Notebook`,price:9}],r=e=>{let t=e.currentTarget.dataset.value,r=n.find(e=>e.id===t);r&&($.add(r),Ze.add({title:`Added to cart`,description:r.name,type:`success`}))};var i=olum.mkElm(`div`,`ProductList`,`96n2140zb9i`),a={addToCart:r},o={__style__(){return``},methods:{},props:{},compName:`ProductList`,deps:null,components:{Button:J,Card:At,CardContent:Tn,Badge:Et},get getElm(){var e=i.isConnected?olum.vdom.mkStaging(i):i;return e.innerHTML=`
      <div>
...
<olum name="SiteFooter"></olum>`,olum.injectStyle(`page`,a.__style__()),olum.handleMarkup(`page`,`btyi218duki`,e,i)}};return{methods:a.methods,props:a.props,__OLUM__:a,el:r,methodsRef:i,stateProps:null,localsRef:{get happening(){return t},get loveItems(){return n}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Rn=e=>{let t=e||`FadeDemo`;var n={on:!0};let r=()=>n.on=!n.on;var i=olum.mkElm(`div`,`FadeDemo`,`2qrabblg47b`),a={toggle:r},o={__style__(){return``},methods:{},props:{},compName:`FadeDemo`,deps:[`on`],components:{Button:J},get getElm(){var e=i.isConnected?olum.vdom.mkStaging(i):i;return e.innerHTML=`
...
<olum name="SiteFooter"></olum>`,olum.injectStyle(`page`,b.__style__()),olum.handleMarkup(`page`,`od5y48bmzxt`,e,y)}};return n.__olum__={compName:t,compId:`od5y48bmzxt`},n=olum.proxyHandler(n,null,v),{methods:b.methods,props:b.props,__OLUM__:b,el:v,methodsRef:y,stateProps:n,localsRef:{get happening(){return g},get loveItems(){return _}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Un=e=>{let t=e||`Accordion`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`flex w-full flex-col [&>*:not(:last-child)>[data-slot=accordion-item]]:border-b`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`Accordion`,`vzg30co0mlp`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`Accordion`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="accordion" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`Accordion`,c.__style__()),olum.handleMarkup(`Accordion`,`vzg30co0mlp`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Wn=e=>{let t=e||`AccordionItem`,n=d(t),{name:r=`accordion`,type:i=`checkbox`,defaultOpen:a=!1,disabled:o=!1,class:s=``,children:c}=d(t),l=()=>q(`group/accordion-item [&>*:has([data-slot=accordion-content])]:grid [&>*:has([data-slot=accordion-content])]:grid-rows-[0fr] [&>*:has([data-slot=accordion-content])]:transition-[grid-template-rows] has-[>input:checked]:[&>*:has([data-slot=accordion-content])]:grid-rows-[1fr] has-[>input:checked]:[&_[data-slot=accordion-trigger-icon-down]]:hidden has-[>input:checked]:[&_[data-slot=accordion-trigger-icon-up]]:inline`,n.class===void 0?``:n.class);var u=olum.mkElm(`div`,`AccordionItem`,`6sdj0g2i0ir`),f={classes:l},p={__style__(){return``},methods:{},props:{},compName:`AccordionItem`,deps:null,components:{},get getElm(){var e=u.isConnected?olum.vdom.mkStaging(u):u;return e.innerHTML=`
...
</div>`,olum.injectStyle(`CarouselContent`,p.__style__()),olum.handleMarkup(`CarouselContent`,`4w56z1scqpb`,e,f)}};return a.__olum__={compName:t,compId:`4w56z1scqpb`},a=olum.proxyHandler(a,null,l),{methods:p.methods,props:p.props,__OLUM__:p,el:l,methodsRef:f,stateProps:a,localsRef:{},hooks:{mounted:s===void 0?null:s,unMounted:null,isMounted:!1,isUnMounted:!1}}},br=e=>{let t=e||`CarouselItem`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`min-w-0 shrink-0 grow-0 basis-full`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`CarouselItem`,`hzeiq5g6hoj`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`CarouselItem`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="carousel-item" role="group" aria-roledescription="slide" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`CarouselItem`,c.__style__()),olum.handleMarkup(`CarouselItem`,`hzeiq5g6hoj`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},xr=e=>{let t=e||`CarouselNext`,n=d(t),{class:r=``}=d(t);var i={id:null};let a=()=>{let e=p.closest(`[data-slot="carousel"]`);return{viewport:e&&e.querySelector(`[data-slot="carousel-content"]`),track:e&&e.querySelector(`[data-slot="carousel-track"]`)}};var s=o(()=>{let e=p.closest(`[data-slot="carousel"]`);e&&(i.id=e.dataset.carouselId)});let c=()=>{if(i.id==null)return!1;let{track:e,viewport:t}=a();if(!e||!t)return!1;let n=Math.max(0,e.scrollWidth-t.clientWidth);return dr.getOffset(i.id)>=n-1},l=()=>{let{track:e,viewport:t}=a();if(!e||!t||i.id==null)return;let n=Math.max(0,e.scrollWidth-t.clientWidth),r=dr.getOffset(i.id);vr(r,Math.min(n,r+t.clientWidth+16),600,e=>{mr(i.id,e)})},u=()=>q(`absolute inset-y-0 -right-12 z-10 my-auto inline-flex size-7 touch-manipulation items-center justify-center rounded-full border border-border bg-background transition-all hover:bg-muted disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-3.5`,n.class===void 0?``:n.class);var f=olum.mkElm(`div`,`CarouselNext`,`l5xb34jss7s`),p=f,m={parts:a,isDisabled:c,go:l,classes:u},h={__style__(){return``},methods:{},props:{},compName:`CarouselNext`,deps:null,components:{},get getElm(){var e=f.isConnected?olum.vdom.mkStaging(f):f;return e.innerHTML=`
...
</button>`,olum.injectStyle(`CarouselNext`,h.__style__()),olum.handleMarkup(`CarouselNext`,`l5xb34jss7s`,e,m)}};return i.__olum__={compName:t,compId:`l5xb34jss7s`},i=olum.proxyHandler(i,null,f),{methods:h.methods,props:h.props,__OLUM__:h,el:f,methodsRef:m,stateProps:i,localsRef:{},hooks:{mounted:s===void 0?null:s,unMounted:null,isMounted:!1,isUnMounted:!1}}},Sr=e=>{let t=e||`CarouselPrevious`,n=d(t),{class:r=``}=d(t);var i={id:null};let a=()=>{let e=p.closest(`[data-slot="carousel"]`);return{viewport:e&&e.querySelector(`[data-slot="carousel-content"]`),track:e&&e.querySelector(`[data-slot="carousel-track"]`)}};var s=o(()=>{let e=p.closest(`[data-slot="carousel"]`);e&&(i.id=e.dataset.carouselId)});let c=()=>i.id==null||dr.getOffset(i.id)<=0,l=()=>{let{track:e,viewport:t}=a();if(!e||!t||i.id==null)return;let n=dr.getOffset(i.id);vr(n,Math.max(0,n-(t.clientWidth+16)),600,e=>{mr(i.id,e)})},u=()=>q(`absolute inset-y-0 -left-12 z-10 my-auto inline-flex size-7 touch-manipulation items-center justify-center rounded-full border border-border bg-background transition-all hover:bg-muted disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-3.5`,n.class===void 0?``:n.class);var f=olum.mkElm(`div`,`CarouselPrevious`,`qa4x9d9s23`),p=f,m={parts:a,isDisabled:c,go:l,classes:u},h={__style__(){return``},methods:{},props:{},compName:`CarouselPrevious`,deps:null,components:{},get getElm(){var e=f.isConnected?olum.vdom.mkStaging(f):f;return e.innerHTML=`
  ...
  <svg class="min-h-0 w-full flex-1" viewBox="0 0 480 250" preserveAspectRatio="xMidYMid meet">
    ...
    ${(n.data===void 0?[]:n.data).map(function(e,t){return`
      ...
      <rect x="${olum.esc(10+t*f())}" y="${olum.esc(10)}" width="${olum.esc(f())}" height="${olum.esc(214)}" fill="${olum.esc(c.hover===t?`var(--olum-muted)`:`transparent`)}" data-o-event='onmouseenter|__olumAnon_pu2zgz1=${JSON.stringify([`$event`,t])}OLUM_EVT_SEPonmouseleave|__olumAnon_6e8rtkn=${JSON.stringify([`$event`])}' key="${olum.esc(e[n.xKey===void 0?`month`:n.xKey])}"></rect>
  ...
  <svg class="min-h-0 w-full flex-1" viewBox="0 0 480 250" preserveAspectRatio="xMidYMid meet">
    ...
    ${(n.data===void 0?[]:n.data).map(function(e,t){return`
      ...
      <rect x="${olum.esc(10+t*p())}" y="${olum.esc(10)}" width="${olum.esc(p())}" height="${olum.esc(214)}" fill="transparent" data-o-event='onmouseenter|__olumAnon_dvd3lgb=${JSON.stringify([`$event`,t])}OLUM_EVT_SEPonmouseleave|__olumAnon_lhrfa2w=${JSON.stringify([`$event`])}' key="${olum.esc(e[n.xKey===void 0?`month`:n.xKey])}"></rect>
  ...
  <div class="relative w-full max-w-56">
    <svg class="w-full" viewBox="0 0 250 250">
      ${f().map(function(e,t){return`
        ...
        <circle cx="${olum.esc(125)}" cy="${olum.esc(125)}" r="${olum.esc(v(t))}" fill="none" stroke="transparent" stroke-width="${olum.esc(22)}" data-o-event='onmouseenter|__olumAnon_71m11s3=${JSON.stringify([`$event`,t])}OLUM_EVT_SEPonmouseleave|__olumAnon_qnofj9x=${JSON.stringify([`$event`])}' key="${olum.esc(e)}"></circle>
      `}).join(``)}
    </svg>
    <div class="pointer-events-none absolute inset-0 grid place-items-center">
      <div class="flex flex-col items-center">
...
</div>`,olum.injectStyle(`RadialBarChart`,A.__style__()),olum.handleMarkup(`RadialBarChart`,`m7kodhz6wj`,e,k)}};return c.__olum__={compName:t,compId:`m7kodhz6wj`},c=olum.proxyHandler(c,null,O),{methods:A.methods,props:A.props,__OLUM__:A,el:O,methodsRef:k,stateProps:c,localsRef:{get W(){return 250},get H(){return 250},get OUTER_R(){return 96},get RING_WIDTH(){return 14}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},jr=e=>{let t=e||`Collapsible`,n=d(t),{defaultOpen:r=!1,disabled:i=!1,class:a=``,children:o}=d(t),s=()=>q(`group/collapsible [&>*:has([data-slot=collapsible-content])]:grid [&>*:has([data-slot=collapsible-content])]:grid-rows-[0fr] [&>*:has([data-slot=collapsible-content])]:transition-[grid-template-rows] has-[>input:checked]:[&>*:has([data-slot=collapsible-content])]:grid-rows-[1fr]`,n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`Collapsible`,`pq7upvavh7a`),l={classes:s},u={__style__(){return``},methods:{},props:{},compName:`Collapsible`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
  ...
  ${n.children}
</div>`,olum.injectStyle(`Collapsible`,u.__style__()),olum.handleMarkup(`Collapsible`,`pq7upvavh7a`,e,l)}};return{methods:u.methods,props:u.props,__OLUM__:u,el:c,methodsRef:l,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Mr=e=>{let t=e||`CollapsibleTrigger`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.closest(`[data-slot="collapsible"]`),t=e&&e.querySelector(`:scope > input`),n=l.querySelector(`button`),r=()=>{!t||t.disabled||(t.checked=!t.checked,t.dispatchEvent(new Event(`change`,{bubbles:!0})))};return n.addEventListener(`click`,r),()=>n.removeEventListener(`click`,r)});let s=()=>q(n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`CollapsibleTrigger`,`bftuvywwjhk`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`CollapsibleTrigger`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <button type="button" data-slot="collapsible-trigger" class="${olum.esc(s())}">${n.children}</button>`,olum.injectStyle(`CollapsibleTrigger`,f.__style__()),olum.handleMarkup(`CollapsibleTrigger`,`bftuvywwjhk`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},Nr=e=>{let t=e||`CollapsibleContent`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`CollapsibleContent`,`dpfx8n97hip`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`CollapsibleContent`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="collapsible-content" class="overflow-hidden min-h-0"><div class="${olum.esc(a())}">${n.children}</div></div>`,olum.injectStyle(`CollapsibleContent`,c.__style__()),olum.handleMarkup(`CollapsibleContent`,`dpfx8n97hip`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Pr=e=>{let t=e||`DropdownMenu`,n=d(t),{children:r}=d(t);var i=olum.mkElm(`div`,`DropdownMenu`,`urddz057bx`),a={},o={__style__(){return``},methods:{},props:{},compName:`DropdownMenu`,deps:null,components:{},get getElm(){var e=i.isConnected?olum.vdom.mkStaging(i):i;return e.innerHTML=`
  ...
  ${n.children}
</button>`,olum.injectStyle(`DropdownMenuCheckboxItem`,_.__style__()),olum.handleMarkup(`DropdownMenuCheckboxItem`,`jzih04ddrs`,e,g)}};return u.__olum__={compName:t,compId:`jzih04ddrs`},u=olum.proxyHandler(u,null,h),{methods:_.methods,props:_.props,__OLUM__:_,el:h,methodsRef:g,stateProps:u,localsRef:{get base(){return p}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Rr=e=>{let t=e||`Table`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`table w-full caption-bottom border-collapse text-sm [&>[data-olum]]:contents`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`Table`,`crp1kb51c4h`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`Table`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="table-container" class="relative w-full overflow-x-auto">
  <div data-slot="table" role="table" class="${olum.esc(a())}">${n.children}</div>
</div>`,olum.injectStyle(`Table`,c.__style__()),olum.handleMarkup(`Table`,`crp1kb51c4h`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},zr=e=>{let t=e||`TableHeader`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`table-header-group [&_[data-slot=table-row]]:border-b [&>[data-olum]]:contents`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`TableHeader`,`4j21mtw53rd`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`TableHeader`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="table-header" role="rowgroup" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`TableHeader`,c.__style__()),olum.handleMarkup(`TableHeader`,`4j21mtw53rd`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Br=e=>{let t=e||`TableBody`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`table-row-group [&>*:last-child>[data-slot=table-row]]:border-0 [&>[data-olum]]:contents`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`TableBody`,`l2m5grbve`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`TableBody`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="table-body" role="rowgroup" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`TableBody`,c.__style__()),olum.handleMarkup(`TableBody`,`l2m5grbve`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Vr=e=>{let t=e||`TableRow`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`table-row border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted [&>[data-olum]]:contents`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`TableRow`,`ro82ak023vi`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`TableRow`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="table-row" role="row" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`TableRow`,c.__style__()),olum.handleMarkup(`TableRow`,`ro82ak023vi`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Hr=e=>{let t=e||`TableHead`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`table-cell h-10 px-2 text-left align-middle font-medium whitespace-nowrap text-foreground [&:has([role=checkbox])]:pr-0`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`TableHead`,`k4ai2nfstab`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`TableHead`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="table-head" role="columnheader" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`TableHead`,c.__style__()),olum.handleMarkup(`TableHead`,`k4ai2nfstab`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ur=e=>{let t=e||`TableCell`,n=d(t),{colspan:r,class:i=``,children:a}=d(t),o=()=>q(`table-cell p-2 align-middle whitespace-nowrap [&:has([role=checkbox])]:pr-0`,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`TableCell`,`v49gj8d2u3`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`TableCell`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <div data-slot="table-cell" role="cell" colspan="${olum.esc(n.colspan)}" class="${olum.esc(o())}">${n.children}</div>`,olum.injectStyle(`TableCell`,l.__style__()),olum.handleMarkup(`TableCell`,`v49gj8d2u3`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Wr=e=>{let t=e||`DataTable`,n=d(t),{data:r=[],columns:i=[],search:a=!1,searchPlaceholder:s=`Filter...`,pageSize:c=10,selectable:l=!1,showPagination:u=!0,showPrevNext:f=!1,showExport:p=!1,rowLink:m,class:h=``}=d(t);var g={q:``,sortKey:null,sortDir:`asc`,hidden:{},page:0,selected:{}};let _=e=>{g.q=e.target.value,g.page=0},v=e=>{let t=e==null?``:String(e);return/[",\n]/.test(t)?`"`+t.replace(/"/g,`""`)+`"`:t},y=()=>{let e=x().filter(e=>g.selected[e.id]);return e.length?e:x()},b=()=>{let e=C(),t=[e.map(e=>v(e.label)).join(`,`),...y().map(t=>e.map(e=>v(E(t,e))).join(`,`))],n=new Blob([t.join(`
`)],{type:`text/csv;charset=utf-8;`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`export.csv`,i.click(),URL.revokeObjectURL(r)},x=()=>{let e=g.q.trim().toLowerCase();return e?(n.data===void 0?[]:n.data).filter(t=>Object.values(t).some(t=>String(t).toLowerCase().includes(e))):n.data===void 0?[]:n.data},S=()=>{let e=x().slice();g.sortKey&&e.sort((e,t)=>{let n=e[g.sortKey],r=t[g.sortKey],i=n>r?1:n<r?-1:0;return g.sortDir===`desc`?-i:i});let t=D()*(n.pageSize===void 0?10:n.pageSize);return e.slice(t,t+(n.pageSize===void 0?10:n.pageSize))},C=()=>(n.columns===void 0?[]:n.columns).filter(e=>!g.hidden[e.key]),w=e=>{g.sortKey===e?g.sortDir=g.sortDir===`asc`?`desc`:`asc`:(g.sortKey=e,g.sortDir=`asc`)},T=(e,t)=>{g.hidden={...g.hidden,[e]:!t}},E=(e,t)=>t.format===`currency`?new Intl.NumberFormat(`en-US`,{style:`currency`,currency:`USD`}).format(+e[t.key]):e[t.key],D=()=>Math.min(Math.max(0,g.page),N()-1),O=()=>D()>0,k=()=>(D()+1)*(n.pageSize===void 0?10:n.pageSize)<x().length,A=()=>O()&&(g.page=D()-1),j=()=>k()&&(g.page=D()+1),M=()=>Math.min((D()+1)*(n.pageSize===void 0?10:n.pageSize),x().length),N=()=>Math.max(1,Math.ceil(x().length/(n.pageSize===void 0?10:n.pageSize))),P=()=>D()+1,ee=e=>g.page=Math.min(Math.max(0,e-1),N()-1),F=()=>g.page=0,te=()=>g.page=N()-1,ne=()=>{let e=N(),t=P(),n=new Set([1,e]);for(let r=t-1;r<=t+1;r++)r>=1&&r<=e&&n.add(r);let r=Array.from(n).sort((e,t)=>e-t),i=[];return r.forEach((e,t)=>{t>0&&e-r[t-1]>1&&i.push(`...`+r[t-1]),i.push(e)}),i},I=()=>typeof n.rowLink==`function`,L=e=>I()&&n.rowLink(e)||{},R=e=>!!g.selected[e],z=()=>x().filter(e=>g.selected[e.id]).length,re=()=>S().length>0&&S().every(e=>g.selected[e.id]),ie=(e,t)=>{let n={...g.selected};t?n[e]=!0:delete n[e],g.selected=n},B=e=>{let t={...g.selected};S().forEach(n=>{e?t[n.id]=!0:delete t[n.id]}),g.selected=t};var ae=o(()=>{let e=e=>{let t=e.target.closest(`[data-slot="button"][data-role="sort"]`);if(t&&t.dataset.value){w(t.dataset.value);return}let n=e.target.closest(`[data-slot="button"][data-role="page"]`);if(n){let e=n.dataset.value;e===`first`?F():e===`last`?te():ee(+e);return}let r=e.target.closest(`[data-slot="dropdown-menu-checkbox-item"]`);if(r&&r.dataset.value){T(r.dataset.value,r.getAttribute(`aria-checked`)===`true`);return}let i=e.target.closest(`input[data-role="select-all"]`);if(i){B(i.checked);return}let a=e.target.closest(`input[data-row-id]`);a&&ie(a.dataset.rowId,a.checked)};return ce.addEventListener(`click`,e),()=>ce.removeEventListener(`click`,e)});let oe=()=>q(`flex w-full flex-col gap-3`,n.class===void 0?``:n.class),V=`peer relative flex size-4 shrink-0 appearance-none items-center justify-center rounded-[4px] border border-border bg-background transition-colors outline-none cursor-pointer focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 checked:border-primary checked:bg-primary checked:text-primary-foreground`,se=`pointer-events-none absolute inset-0 m-auto size-3.5 text-primary-foreground`;var H=olum.mkElm(`div`,`DataTable`,`72kolg4owae`),ce=H,le={onSearchInput:_,csvEscape:v,exportRows:y,exportCsv:b,filtered:x,rows:S,shown:C,sortBy:w,toggleCol:T,fmt:E,safePage:D,canPrev:O,canNext:k,prevPage:A,nextPage:j,shownCount:M,totalPages:N,currentPage:P,goToPage:ee,goFirst:F,goLast:te,pageNumbers:ne,hasRowLink:I,linkFor:L,isRowSelected:R,selectedCount:z,isPageAllSelected:re,toggleRow:ie,toggleAllRows:B,classes:oe},ue={__style__(){return``},methods:{},props:{},compName:`DataTable`,deps:null,components:{Input:yt,Button:J,DropdownMenu:Pr,DropdownMenuTrigger:Fr,DropdownMenuContent:Ir,DropdownMenuCheckboxItem:Lr,Table:Rr,TableHeader:zr,TableBody:Br,TableRow:Vr,TableHead:Hr,TableCell:Ur},get getElm(){var e=H.isConnected?olum.vdom.mkStaging(H):H;return e.innerHTML=`
...
<olum name="SiteFooter"></olum>`,olum.injectStyle(`page`,h.__style__()),olum.handleMarkup(`page`,`8w6vl54pues`,e,m)}};return d.__olum__={compName:t,compId:`8w6vl54pues`},d=olum.proxyHandler(d,null,p),{methods:h.methods,props:h.props,__OLUM__:h,el:p,methodsRef:m,stateProps:d,localsRef:{get barData(){return r},get barConfig(){return i},get donutData(){return a},get composedConfig(){return o},get radialData(){return s},get radialConfig(){return c},get tableRows(){return l},get tableColumns(){return u}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},xi=e=>{let t=e||`Alert`,n=d(t),{variant:r=`default`,class:i=``,children:a}=d(t),o=`group/alert relative grid w-full gap-0.5 rounded-lg border border-border px-2.5 py-2 text-left text-sm has-[[data-slot=alert-action]]:pr-18 has-[>[data-icon]]:grid-cols-[auto_1fr] has-[>[data-icon]]:gap-x-2 [&>[data-icon]]:row-span-2 [&>[data-icon]]:translate-y-0.5 [&>[data-icon]]:text-current [&>[data-icon]_svg:not([class*='size-'])]:size-4 [&>*:has([data-slot=alert-action])]:absolute [&>*:has([data-slot=alert-action])]:top-2 [&>*:has([data-slot=alert-action])]:right-2`,s={default:`bg-background text-foreground`,destructive:`bg-background text-destructive [&_[data-slot=alert-description]]:text-destructive/90`},c=()=>q(o,s[n.variant===void 0?`default`:n.variant]||s.default,n.class===void 0?``:n.class);var l=olum.mkElm(`div`,`Alert`,`ugufk0uwld`),u={classes:c},f={__style__(){return``},methods:{},props:{},compName:`Alert`,deps:null,components:{},get getElm(){var e=l.isConnected?olum.vdom.mkStaging(l):l;return e.innerHTML=`
      <div data-slot="alert" role="alert" class="${olum.esc(c())}">${n.children}</div>`,olum.injectStyle(`Alert`,f.__style__()),olum.handleMarkup(`Alert`,`ugufk0uwld`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:l,methodsRef:u,stateProps:null,localsRef:{get base(){return o},get variants(){return s}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Si=e=>{let t=e||`AlertTitle`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`font-medium [&_a]:underline [&_a]:underline-offset-3 [&_a:hover]:text-foreground`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`AlertTitle`,`b7tzba2kixn`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`AlertTitle`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="alert-title" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`AlertTitle`,c.__style__()),olum.handleMarkup(`AlertTitle`,`b7tzba2kixn`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ci=e=>{let t=e||`AlertDescription`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`text-sm text-balance text-muted-foreground md:text-pretty [&_a]:underline [&_a]:underline-offset-3 [&_a:hover]:text-foreground [&_p:not(:last-child)]:mb-4`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`AlertDescription`,`pq6k503ioq`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`AlertDescription`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="alert-description" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`AlertDescription`,c.__style__()),olum.handleMarkup(`AlertDescription`,`pq6k503ioq`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},wi=e=>{let t=e||`AlertAction`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`flex items-center gap-1`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`AlertAction`,`vr82zkdl3c`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`AlertAction`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="alert-action" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`AlertAction`,c.__style__()),olum.handleMarkup(`AlertAction`,`vr82zkdl3c`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ti=e=>{let t=e||`Empty`,n=d(t),{class:r=``,children:i}=d(t),a=`flex w-full min-w-0 flex-1 flex-col items-center justify-center gap-4 rounded-xl border-dashed p-6 text-center text-balance`,o=()=>q(a,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`Empty`,`ouw2siy4r2q`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`Empty`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <div data-slot="empty" class="${olum.esc(o())}">${n.children}</div>`,olum.injectStyle(`Empty`,l.__style__()),olum.handleMarkup(`Empty`,`ouw2siy4r2q`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{get base(){return a}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ei=e=>{let t=e||`EmptyHeader`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`flex max-w-sm flex-col items-center gap-2`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`EmptyHeader`,`xd3c1of9xi`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`EmptyHeader`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="empty-header" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`EmptyHeader`,c.__style__()),olum.handleMarkup(`EmptyHeader`,`xd3c1of9xi`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Di=e=>{let t=e||`EmptyMedia`,n=d(t),{variant:r=`default`,class:i=``,children:a}=d(t),o=`mb-2 flex shrink-0 items-center justify-center [&_svg]:pointer-events-none [&_svg]:shrink-0`,s={default:`bg-transparent`,icon:`flex size-8 shrink-0 items-center justify-center rounded-lg bg-muted text-foreground [&_svg:not([class*='size-'])]:size-4`},c=()=>q(o,s[n.variant===void 0?`default`:n.variant]||s.default,n.class===void 0?``:n.class);var l=olum.mkElm(`div`,`EmptyMedia`,`xhe3lhkmlkk`),u={classes:c},f={__style__(){return``},methods:{},props:{},compName:`EmptyMedia`,deps:null,components:{},get getElm(){var e=l.isConnected?olum.vdom.mkStaging(l):l;return e.innerHTML=`
      <div data-slot="empty-icon" data-variant="${olum.esc(n.variant===void 0?`default`:n.variant)}" class="${olum.esc(c())}">${n.children}</div>`,olum.injectStyle(`EmptyMedia`,f.__style__()),olum.handleMarkup(`EmptyMedia`,`xhe3lhkmlkk`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:l,methodsRef:u,stateProps:null,localsRef:{get base(){return o},get variants(){return s}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Oi=e=>{let t=e||`EmptyTitle`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`font-heading text-sm font-medium tracking-tight`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`EmptyTitle`,`25ml2v44dov`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`EmptyTitle`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="empty-title" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`EmptyTitle`,c.__style__()),olum.handleMarkup(`EmptyTitle`,`25ml2v44dov`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ki=e=>{let t=e||`EmptyDescription`,n=d(t),{class:r=``,children:i}=d(t),a=`text-sm/relaxed text-muted-foreground [&>a]:underline [&>a]:underline-offset-4 [&>a:hover]:text-primary`,o=()=>q(a,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`EmptyDescription`,`7lmgb7cpsgt`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`EmptyDescription`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <div data-slot="empty-description" class="${olum.esc(o())}">${n.children}</div>`,olum.injectStyle(`EmptyDescription`,l.__style__()),olum.handleMarkup(`EmptyDescription`,`7lmgb7cpsgt`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{get base(){return a}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ai=e=>{let t=e||`EmptyContent`,n=d(t),{class:r=``,children:i}=d(t),a=`flex w-full max-w-sm min-w-0 flex-col items-center gap-2.5 text-sm text-balance`,o=()=>q(a,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`EmptyContent`,`8emde4pg3e2`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`EmptyContent`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <div data-slot="empty-content" class="${olum.esc(o())}">${n.children}</div>`,olum.injectStyle(`EmptyContent`,l.__style__()),olum.handleMarkup(`EmptyContent`,`8emde4pg3e2`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{get base(){return a}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ji=e=>{let t=e||`Progress`,n=d(t),{value:r=0,class:i=``}=d(t),a=()=>q(`flex flex-wrap gap-3`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`Progress`,`gvtt4rn4k6g`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`Progress`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
...
<olum name="SiteFooter"></olum>`,olum.injectStyle(`page`,p.__style__()),olum.handleMarkup(`page`,`a8j9gvwvmra`,e,f)}};return n.__olum__={compName:t,compId:`a8j9gvwvmra`},n=olum.proxyHandler(n,null,d),{methods:p.methods,props:p.props,__OLUM__:p,el:d,methodsRef:f,stateProps:n,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},zi=e=>{let t=e||`ButtonGroup`,n=d(t),{orientation:r=`horizontal`,class:i=``,children:a}=d(t),o=`flex w-fit items-stretch [&>[data-olum]]:contents [&_*:focus-visible]:relative [&_*:focus-visible]:z-10 [&>input]:flex-1`,s={horizontal:`[&_[data-slot]]:rounded-none [&>*:first-child_[data-slot]]:rounded-s-lg [&>*:last-child_[data-slot]]:rounded-e-lg [&>*:not(:first-child)_[data-slot]]:border-s-0`,vertical:`flex-col [&_[data-slot]]:rounded-none [&>*:first-child_[data-slot]]:rounded-t-lg [&>*:last-child_[data-slot]]:rounded-b-lg [&>*:not(:first-child)_[data-slot]]:border-t-0`},c=()=>q(o,s[n.orientation===void 0?`horizontal`:n.orientation]||s.horizontal,n.class===void 0?``:n.class);var l=olum.mkElm(`div`,`ButtonGroup`,`itxzbt77bye`),u={classes:c},f={__style__(){return``},methods:{},props:{},compName:`ButtonGroup`,deps:null,components:{},get getElm(){var e=l.isConnected?olum.vdom.mkStaging(l):l;return e.innerHTML=`
      <div role="group" data-slot="button-group" data-orientation="${olum.esc(n.orientation===void 0?`horizontal`:n.orientation)}" class="${olum.esc(c())}">${n.children}</div>`,olum.injectStyle(`ButtonGroup`,f.__style__()),olum.handleMarkup(`ButtonGroup`,`itxzbt77bye`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:l,methodsRef:u,stateProps:null,localsRef:{get base(){return o},get orientations(){return s}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Bi=e=>{let t=e||`ButtonGroupSeparator`,n=d(t),{orientation:r=`vertical`,class:i=``}=d(t),a=`relative shrink-0 self-stretch bg-border data-[orientation=horizontal]:mx-px data-[orientation=horizontal]:h-px data-[orientation=horizontal]:w-auto data-[orientation=vertical]:my-px data-[orientation=vertical]:w-px`,o=()=>q(a,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`ButtonGroupSeparator`,`kdd538hh6ns`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`ButtonGroupSeparator`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <div role="separator" aria-orientation="${olum.esc(n.orientation===void 0?`vertical`:n.orientation)}" data-slot="separator" data-orientation="${olum.esc(n.orientation===void 0?`vertical`:n.orientation)}" class="${olum.esc(o())}"></div>`,olum.injectStyle(`ButtonGroupSeparator`,l.__style__()),olum.handleMarkup(`ButtonGroupSeparator`,`kdd538hh6ns`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{get base(){return a}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Vi=e=>{let t=e||`ButtonGroupText`,n=d(t),{class:r=``,children:i}=d(t),a=`flex items-center gap-2 rounded-lg border bg-muted px-2.5 text-sm font-medium [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4`,o=()=>q(a,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`ButtonGroupText`,`n8kqzgiy7r8`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`ButtonGroupText`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <div data-slot="button-group-text" class="${olum.esc(o())}">${n.children}</div>`,olum.injectStyle(`ButtonGroupText`,l.__style__()),olum.handleMarkup(`ButtonGroupText`,`n8kqzgiy7r8`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{get base(){return a}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Hi=e=>{let t=e||`Calendar`,n=d(t),{selected:r,onSelect:i,class:a=``}=d(t),o=new Date;var s={year:o.getFullYear(),month:o.getMonth(),cells:[]};let c=[`Su`,`Mo`,`Tu`,`We`,`Th`,`Fr`,`Sa`],l=()=>new Date(s.year,s.month,1).toLocaleDateString(`en-US`,{month:`long`,year:`numeric`}),u=()=>{let e=new Date(s.year,s.month,1),t=new Date(s.year,s.month,1-e.getDay()),r=[];for(let e=0;e<42;e++){let i=new Date(t.getFullYear(),t.getMonth(),t.getDate()+e);r.push({ts:i.getTime(),day:i.getDate(),outside:i.getMonth()!==s.month,today:i.toDateString()===new Date().toDateString(),selected:typeof n.selected==`number`&&i.getTime()===n.selected})}return r};s.cells=u();let f=()=>{let e=new Date(s.year,s.month-1,1);s.year=e.getFullYear(),s.month=e.getMonth(),s.cells=u()},p=()=>{let e=new Date(s.year,s.month+1,1);s.year=e.getFullYear(),s.month=e.getMonth(),s.cells=u()},m=e=>{s.cells=s.cells.map(t=>({...t,selected:t.ts===e.ts})),n.onSelect&&n.onSelect(new Date(e.ts))},h=`inline-flex size-7 cursor-pointer items-center justify-center rounded-lg border border-transparent text-foreground outline-none select-none hover:bg-muted hover:text-foreground focus:border-ring focus:ring-3 focus:ring-ring/50 active:translate-y-px`,g=`inline-flex size-7 cursor-pointer items-center justify-center rounded-lg border border-transparent text-sm font-medium outline-none select-none hover:bg-muted focus:border-ring focus:ring-3 focus:ring-ring/50 active:translate-y-px`,_=e=>e.selected?q(g,`bg-primary text-primary-foreground hover:bg-primary/80`):e.today?q(g,`bg-muted text-foreground`):e.outside?q(g,`text-muted-foreground`):g,v=()=>q(`w-fit bg-background p-2`,n.class===void 0?``:n.class);var y=olum.mkElm(`div`,`Calendar`,`wfn1xruyejr`),b={label:l,buildCells:u,prev:f,next:p,pick:m,dayClasses:_,classes:v},x={__style__(){return``},methods:{},props:{},compName:`Calendar`,deps:null,components:{},get getElm(){var e=y.isConnected?olum.vdom.mkStaging(y):y;return e.innerHTML=`
  ...
  <div class="flex items-center justify-between gap-1 pb-2">
    ...
    <div class="text-sm font-medium select-none">${olum.esc(l())}</div>
...
</div>`,olum.injectStyle(`Calendar`,x.__style__()),olum.handleMarkup(`Calendar`,`wfn1xruyejr`,e,b)}};return s.__olum__={compName:t,compId:`wfn1xruyejr`},s=olum.proxyHandler(s,null,y),{methods:x.methods,props:x.props,__OLUM__:x,el:y,methodsRef:b,stateProps:s,localsRef:{get weekdays(){return c},get navBtn(){return h},get dayBase(){return g}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ui=e=>{let t=e||`Checkbox`,n=d(t),{defaultChecked:r=!1,checked:i,disabled:a=!1,required:o=!1,invalid:s=!1,id:c,name:l,class:u=``,onCheckedChange:f}=d(t);var p={checked:n.checked===void 0?n.defaultChecked!==void 0&&n.defaultChecked:n.checked};let m=e=>{p.checked=e.target.checked,n.onCheckedChange&&n.onCheckedChange(e.target.checked)},h=`peer relative flex size-4 shrink-0 appearance-none items-center justify-center rounded-[4px] border border-border bg-background transition-colors outline-none cursor-pointer focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 checked:border-primary checked:bg-primary checked:text-primary-foreground`,g=()=>q(h,n.class===void 0?``:n.class);var _=olum.mkElm(`div`,`Checkbox`,`3jkmbkpp3uw`),v={handleChange:m,classes:g},y={__style__(){return``},methods:{},props:{},compName:`Checkbox`,deps:null,components:{},get getElm(){var e=_.isConnected?olum.vdom.mkStaging(_):_;return e.innerHTML=`
      <span class="relative inline-flex size-4 shrink-0 top-0.75">
...
</span>`,olum.injectStyle(`Checkbox`,y.__style__()),olum.handleMarkup(`Checkbox`,`3jkmbkpp3uw`,e,v)}};return p.__olum__={compName:t,compId:`3jkmbkpp3uw`},p=olum.proxyHandler(p,null,_),{methods:y.methods,props:y.props,__OLUM__:y,el:_,methodsRef:v,stateProps:p,localsRef:{get base(){return h}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Wi=e=>{let t=e||`Combobox`,n=d(t),{items:r=[],placeholder:i=``,emptyText:a=`No results found.`,showClear:s=!1,class:c=``}=d(t);var l={query:``,open:!1,value:null};let u=()=>(n.items===void 0?[]:n.items).filter(e=>e.toLowerCase().includes(l.query.trim().toLowerCase())),f=e=>{l.value=e,l.query=e,l.open=!1},p=()=>{l.value=null,l.query=``};var m=o(()=>{let e=e=>{b.contains(e.target)||(l.open=!1)},t=e=>{e.key===`Escape`&&(l.open=!1)};return document.addEventListener(`click`,e),document.addEventListener(`keydown`,t),()=>{document.removeEventListener(`click`,e),document.removeEventListener(`keydown`,t)}});let h=()=>q(`relative w-64`,n.class===void 0?``:n.class),g=()=>l.open=!0,_=e=>{l.query=e.target.value,l.open=!0},v=()=>l.open=!l.open;var y=olum.mkElm(`div`,`Combobox`,`l1psvuw4hb`),b=y,x={filtered:u,pick:f,clear:p,classes:h,__olumAnon_uztc7b4:g,__olumAnon_ffqt4g4:_,__olumAnon_g78wau1:v},S={__style__(){return``},methods:{},props:{},compName:`Combobox`,deps:null,components:{},get getElm(){var e=y.isConnected?olum.vdom.mkStaging(y):y;return e.innerHTML=`
  ...
  <div class="flex h-8 w-full min-w-0 items-center rounded-lg border border-border bg-background transition-colors focus-within:border-ring focus-within:ring-3 focus-within:ring-ring/50">
    <input data-slot="combobox-input" type="text" class="h-full min-w-0 flex-1 bg-transparent px-2.5 text-sm text-foreground outline-none placeholder:text-muted-foreground" placeholder="${olum.esc(n.placeholder===void 0?``:n.placeholder)}" value="${olum.esc(l.query)}" data-o-event='onfocus|__olumAnon_uztc7b4=${JSON.stringify([`$event`])}OLUM_EVT_SEPoninput|__olumAnon_ffqt4g4=${JSON.stringify([`$event`])}'>
    ${n.showClear!==void 0&&n.showClear&&l.query?`
    ...
    `:`
      <button type="button" data-slot="combobox-trigger" class="mr-1 inline-flex size-6 shrink-0 items-center justify-center rounded-md text-muted-foreground hover:bg-muted hover:text-foreground" data-o-event='onclick|__olumAnon_g78wau1=${JSON.stringify([`$event`])}'>
  ...
  `:``}
</div>`,olum.injectStyle(`Combobox`,S.__style__()),olum.handleMarkup(`Combobox`,`l1psvuw4hb`,e,x)}};return l.__olum__={compName:t,compId:`l1psvuw4hb`},l=olum.proxyHandler(l,null,y),{methods:S.methods,props:S.props,__OLUM__:S,el:y,methodsRef:x,stateProps:l,localsRef:{},hooks:{mounted:m===void 0?null:m,unMounted:null,isMounted:!1,isUnMounted:!1}}},Gi=e=>{let t=e||`DatePicker`,n=d(t),{placeholder:r=`Pick a date`,class:i=``}=d(t);var a={open:!1,ts:null};let s=()=>a.ts?new Date(a.ts).toLocaleDateString(`en-US`,{year:`numeric`,month:`long`,day:`numeric`}):n.placeholder===void 0?`Pick a date`:n.placeholder,c=e=>{a.ts=e.getTime(),a.open=!1};var l=o(()=>{let e=e=>{m.contains(e.target)||(a.open=!1)},t=e=>{e.key===`Escape`&&(a.open=!1)};return document.addEventListener(`click`,e),document.addEventListener(`keydown`,t),()=>{document.removeEventListener(`click`,e),document.removeEventListener(`keydown`,t)}});let u=()=>q(`inline-flex h-8 w-[240px] items-center justify-start gap-1.5 rounded-lg border border-border bg-background px-2.5 text-sm font-normal whitespace-nowrap transition-all outline-none select-none hover:bg-muted focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 [&_svg]:size-4 [&_svg]:shrink-0`,a.ts?``:`text-muted-foreground`,n.class===void 0?``:n.class),f=()=>a.open=!a.open;var p=olum.mkElm(`div`,`DatePicker`,`b0xct4fxua`),m=p,h={label:s,pick:c,triggerClasses:u,__olumAnon_fwwzno2:f},g={__style__(){return``},methods:{},props:{},compName:`DatePicker`,deps:null,components:{Calendar:Hi},get getElm(){var e=p.isConnected?olum.vdom.mkStaging(p):p;return e.innerHTML=`
      <div data-slot="date-picker" class="relative inline-block">
  <button type="button" class="${olum.esc(u())}" data-o-event='onclick|__olumAnon_fwwzno2=${JSON.stringify([`$event`])}'>
  ...
  `:``}
</div>`,olum.injectStyle(`DatePicker`,g.__style__()),olum.handleMarkup(`DatePicker`,`b0xct4fxua`,e,h)}};return a.__olum__={compName:t,compId:`b0xct4fxua`},a=olum.proxyHandler(a,null,p),{methods:g.methods,props:g.props,__OLUM__:g,el:p,methodsRef:h,stateProps:a,localsRef:{},hooks:{mounted:l===void 0?null:l,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ki=e=>{let t=e||`Field`,n=d(t),{orientation:r=`vertical`,class:i=``,children:a}=d(t),o=`group/field flex w-full gap-2 [&>[data-olum]]:contents data-[invalid=true]:text-destructive`,s={vertical:`flex-col`,horizontal:`flex-row items-center has-[[data-slot=field-content]]:items-start`},c=()=>q(o,s[n.orientation===void 0?`vertical`:n.orientation]||s.vertical,n.class===void 0?``:n.class);var l=olum.mkElm(`div`,`Field`,`mrrappwj06`),u={classes:c},f={__style__(){return``},methods:{},props:{},compName:`Field`,deps:null,components:{},get getElm(){var e=l.isConnected?olum.vdom.mkStaging(l):l;return e.innerHTML=`
      <div role="group" data-slot="field" data-orientation="${olum.esc(n.orientation===void 0?`vertical`:n.orientation)}" class="${olum.esc(c())}">${n.children}</div>`,olum.injectStyle(`Field`,f.__style__()),olum.handleMarkup(`Field`,`mrrappwj06`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:l,methodsRef:u,stateProps:null,localsRef:{get base(){return o},get orientations(){return s}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},qi=e=>{let t=e||`FieldContent`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`group/field-content flex flex-1 flex-col gap-0.5 leading-snug`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`FieldContent`,`j5q4mdxqtrk`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`FieldContent`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="field-content" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`FieldContent`,c.__style__()),olum.handleMarkup(`FieldContent`,`j5q4mdxqtrk`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ji=e=>{let t=e||`FieldDescription`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`text-left text-sm leading-normal font-normal text-muted-foreground [&>a]:underline [&>a]:underline-offset-4 [&>a:hover]:text-primary`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`FieldDescription`,`ttj1em4bg8`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`FieldDescription`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <p data-slot="field-description" class="${olum.esc(a())}">${n.children}</p>`,olum.injectStyle(`FieldDescription`,c.__style__()),olum.handleMarkup(`FieldDescription`,`ttj1em4bg8`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Yi=e=>{let t=e||`FieldError`,n=d(t),{errors:r,class:i=``,children:a}=d(t),o=()=>Array.isArray(n.errors)?n.errors.filter(e=>e&&e.message):[],s=()=>q(`text-sm font-normal text-destructive`,n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`FieldError`,`ez28szh6c6s`),l={list:o,classes:s},u={__style__(){return``},methods:{},props:{},compName:`FieldError`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      ${n.children||o().length?`
...
`:``}`,olum.injectStyle(`FieldError`,u.__style__()),olum.handleMarkup(`FieldError`,`ez28szh6c6s`,e,l)}};return{methods:u.methods,props:u.props,__OLUM__:u,el:c,methodsRef:l,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Xi=e=>{let t=e||`FieldGroup`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`group/field-group flex w-full flex-col gap-5 [&>[data-olum]]:contents`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`FieldGroup`,`03gste460k2p`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`FieldGroup`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="field-group" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`FieldGroup`,c.__style__()),olum.handleMarkup(`FieldGroup`,`03gste460k2p`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Zi=e=>{let t=e||`Label`,n=d(t),{for:r,class:i=``,children:a}=d(t),o=`flex items-center gap-2 text-sm leading-none font-medium select-none group-data-[disabled=true]:pointer-events-none group-data-[disabled=true]:opacity-50 group-has-disabled:cursor-not-allowed group-has-disabled:opacity-50`,s=()=>q(o,n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`Label`,`bhzquyqvckh`),l={classes:s},u={__style__(){return``},methods:{},props:{},compName:`Label`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <label for="${olum.esc(n.for)}" class="${olum.esc(s())}">${n.children}</label>`,olum.injectStyle(`Label`,u.__style__()),olum.handleMarkup(`Label`,`bhzquyqvckh`,e,l)}};return{methods:u.methods,props:u.props,__OLUM__:u,el:c,methodsRef:l,stateProps:null,localsRef:{get base(){return o}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Qi=e=>{let t=e||`FieldLabel`,n=d(t),{for:r,class:i=``,children:a}=d(t),o=()=>q(`group/field-label flex w-fit gap-2 leading-snug`,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`FieldLabel`,`zkd9v9u008`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`FieldLabel`,deps:null,components:{Label:Zi},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <olum name="Label" data-o-props='${encodeURIComponent(JSON.stringify({for:n.for,class:o()})).replace(/'/g,`%27`)}' data-o-props-src="for:props:for" data-o-props-owner='${t}'>${n.children}</olum>`,olum.injectStyle(`FieldLabel`,l.__style__()),olum.handleMarkup(`FieldLabel`,`zkd9v9u008`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},$i=e=>{let t=e||`FieldLegend`,n=d(t),{variant:r=`legend`,class:i=``,children:a}=d(t),o=()=>q(`mb-1.5 font-medium`,(n.variant===void 0?`legend`:n.variant)===`label`?`text-sm`:`text-base`,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`FieldLegend`,`tsenszohpo9`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`FieldLegend`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <legend data-slot="field-legend" data-variant="${olum.esc(n.variant===void 0?`legend`:n.variant)}" class="${olum.esc(o())}">${n.children}</legend>`,olum.injectStyle(`FieldLegend`,l.__style__()),olum.handleMarkup(`FieldLegend`,`tsenszohpo9`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ea=e=>{let t=e||`FieldSeparator`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`relative -my-2 h-5 text-sm`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`FieldSeparator`,`zrckbgg3u9`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`FieldSeparator`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
  ...
  `:``}
</div>`,olum.injectStyle(`FieldSeparator`,c.__style__()),olum.handleMarkup(`FieldSeparator`,`zrckbgg3u9`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ta=e=>{let t=e||`FieldSet`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`flex flex-col gap-4 [&>[data-olum]]:contents`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`FieldSet`,`6xsdcevezog`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`FieldSet`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <fieldset data-slot="field-set" class="${olum.esc(a())}">${n.children}</fieldset>`,olum.injectStyle(`FieldSet`,c.__style__()),olum.handleMarkup(`FieldSet`,`6xsdcevezog`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},na=e=>{let t=e||`InputGroup`,n=d(t),{class:r=``,children:i}=d(t),a=`group/input-group relative flex h-8 w-full min-w-0 items-center rounded-lg border border-border transition-colors outline-none has-disabled:bg-muted has-disabled:opacity-50 has-[[data-slot=input-group-control]:focus-visible]:border-ring has-[[data-slot=input-group-control]:focus-visible]:ring-3 has-[[data-slot=input-group-control]:focus-visible]:ring-ring/50 has-[[data-slot][aria-invalid=true]]:border-destructive has-[[data-slot][aria-invalid=true]]:ring-3 has-[[data-slot][aria-invalid=true]]:ring-destructive/20 has-[[data-align=block-end]]:h-auto has-[[data-align=block-end]]:flex-col has-[[data-align=block-start]]:h-auto has-[[data-align=block-start]]:flex-col has-[textarea]:h-auto`,o=()=>q(a,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`InputGroup`,`dlop4jlqry7`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`InputGroup`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <div data-slot="input-group" role="group" class="${olum.esc(o())}">${n.children}</div>`,olum.injectStyle(`InputGroup`,l.__style__()),olum.handleMarkup(`InputGroup`,`dlop4jlqry7`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{get base(){return a}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ra=e=>{let t=e||`InputGroupAddon`,n=d(t),{align:r=`inline-start`,class:i=``,children:a}=d(t),o=`flex h-auto cursor-text items-center justify-center gap-2 py-1.5 text-sm font-medium text-muted-foreground select-none group-data-[disabled=true]/input-group:opacity-50 [&>kbd]:rounded-[calc(var(--radius)-5px)] [&>svg:not([class*='size-'])]:size-4`,s={"inline-start":`order-first pl-2 has-[>button]:ml-[-0.3rem] has-[>kbd]:ml-[-0.15rem]`,"inline-end":`order-last pr-2 has-[>button]:mr-[-0.3rem] has-[>kbd]:mr-[-0.15rem]`,"block-start":`order-first w-full justify-start px-2.5 pt-2`,"block-end":`order-last w-full justify-start px-2.5 pb-2`},c=()=>q(o,s[n.align===void 0?`inline-start`:n.align]||s[`inline-start`],n.class===void 0?``:n.class);var l=olum.mkElm(`div`,`InputGroupAddon`,`bvl4g7fnk6p`),u={classes:c},f={__style__(){return``},methods:{},props:{},compName:`InputGroupAddon`,deps:null,components:{},get getElm(){var e=l.isConnected?olum.vdom.mkStaging(l):l;return e.innerHTML=`
      <div role="group" data-slot="input-group-addon" data-align="${olum.esc(n.align===void 0?`inline-start`:n.align)}" class="${olum.esc(c())}">${n.children}</div>`,olum.injectStyle(`InputGroupAddon`,f.__style__()),olum.handleMarkup(`InputGroupAddon`,`bvl4g7fnk6p`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:l,methodsRef:u,stateProps:null,localsRef:{get base(){return o},get aligns(){return s}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ia=e=>{let t=e||`InputGroupButton`,n=d(t),{type:r=`button`,variant:i=`ghost`,size:a=`xs`,value:o,ariaLabel:s,class:c=``,children:l}=d(t),u={xs:`h-6 gap-1 rounded-[calc(var(--radius)-3px)] px-1.5 [&>svg:not([class*='size-'])]:size-3.5`,sm:``,"icon-xs":`size-6 rounded-[calc(var(--radius)-3px)] p-0`,"icon-sm":`size-8 p-0`},f=()=>q(`flex items-center gap-2 text-sm shadow-none`,u[n.size===void 0?`xs`:n.size]||u.xs,n.class===void 0?``:n.class);var p=olum.mkElm(`div`,`InputGroupButton`,`gb9k9ufyyip`),m={classes:f},h={__style__(){return``},methods:{},props:{},compName:`InputGroupButton`,deps:null,components:{Button:J},get getElm(){var e=p.isConnected?olum.vdom.mkStaging(p):p;return e.innerHTML=`
      <olum name="Button" data-o-props='${encodeURIComponent(JSON.stringify({type:n.type===void 0?`button`:n.type,variant:n.variant===void 0?`ghost`:n.variant,value:n.value,ariaLabel:n.ariaLabel,class:f()})).replace(/'/g,`%27`)}' data-o-props-src="value:props:value|ariaLabel:props:ariaLabel" data-o-props-owner='${t}'>${n.children}</olum>`,olum.injectStyle(`InputGroupButton`,h.__style__()),olum.handleMarkup(`InputGroupButton`,`gb9k9ufyyip`,e,m)}};return{methods:h.methods,props:h.props,__OLUM__:h,el:p,methodsRef:m,stateProps:null,localsRef:{get sizes(){return u}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},aa=e=>{let t=e||`InputGroupInput`,n=d(t),{class:r=``,placeholder:i,value:a,id:o,name:s,disabled:c=!1}=d(t),l=()=>q(`flex-1 rounded-none border-0 bg-transparent shadow-none ring-0 focus-visible:ring-0 disabled:bg-transparent`,n.class===void 0?``:n.class);var u=olum.mkElm(`div`,`InputGroupInput`,`n4nyu1bw31r`),f={classes:l},p={__style__(){return``},methods:{},props:{},compName:`InputGroupInput`,deps:null,components:{Input:yt},get getElm(){var e=u.isConnected?olum.vdom.mkStaging(u):u;return e.innerHTML=`
      <olum name="Input" data-o-props='${encodeURIComponent(JSON.stringify({slot:`input-group-control`,placeholder:n.placeholder,value:n.value,id:n.id,name:n.name,disabled:n.disabled!==void 0&&n.disabled,class:l()})).replace(/'/g,`%27`)}' data-o-props-src="placeholder:props:placeholder|value:props:value|id:props:id|name:props:name" data-o-props-owner='${t}'></olum>`,olum.injectStyle(`InputGroupInput`,p.__style__()),olum.handleMarkup(`InputGroupInput`,`n4nyu1bw31r`,e,f)}};return{methods:p.methods,props:p.props,__OLUM__:p,el:u,methodsRef:f,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},oa=e=>{let t=e||`InputOTP`,n=d(t),{class:r=``,containerClass:i=``,children:a}=d(t),o=()=>q(`flex items-center has-disabled:opacity-50`,n.class===void 0?``:n.class,n.containerClass===void 0?``:n.containerClass);var s=olum.mkElm(`div`,`InputOTP`,`l3rj6tmm6fk`),c={containerClasses:o},l={__style__(){return``},methods:{},props:{},compName:`InputOTP`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <div data-slot="input-otp" class="${olum.esc(o())}">${n.children}</div>`,olum.injectStyle(`InputOTP`,l.__style__()),olum.handleMarkup(`InputOTP`,`l3rj6tmm6fk`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},sa=e=>{let t=e||`InputOTPGroup`,n=d(t),{class:r=``,children:i}=d(t),a=`flex items-center rounded-lg has-aria-invalid:border-destructive has-aria-invalid:ring-3 has-aria-invalid:ring-destructive/20 [&>[data-olum]]:contents [&>*:first-child>input]:rounded-l-lg [&>*:first-child>input]:border-l [&>*:last-child>input]:rounded-r-lg`,o=()=>q(a,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`InputOTPGroup`,`9w4bjp389p`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`InputOTPGroup`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <div data-slot="input-otp-group" class="${olum.esc(o())}">${n.children}</div>`,olum.injectStyle(`InputOTPGroup`,l.__style__()),olum.handleMarkup(`InputOTPGroup`,`9w4bjp389p`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{get base(){return a}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ca=e=>{var t=olum.mkElm(`div`,`InputOTPSeparator`,`09ib9gr3vu6o`),n={},r={__style__(){return``},methods:{},props:{},compName:`InputOTPSeparator`,deps:null,components:{},get getElm(){var e=t.isConnected?olum.vdom.mkStaging(t):t;return e.innerHTML=`
...
</div>`,olum.injectStyle(`InputOTPSeparator`,r.__style__()),olum.handleMarkup(`InputOTPSeparator`,`09ib9gr3vu6o`,e,n)}};return{methods:r.methods,props:r.props,__OLUM__:r,el:t,methodsRef:n,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},la=e=>{let t=e||`InputOTPSlot`,n=d(t),{index:r=0,class:i=``}=d(t),a=`relative flex size-8 items-center justify-center border-y border-r border-border bg-transparent text-center text-sm outline-none transition-all focus:z-10 focus:border-ring focus:ring-3 focus:ring-ring/50 appearance-none`,s=()=>q(a,n.class===void 0?``:n.class);var c=o(()=>{let e=u.querySelector(`input`),t=()=>{let e=u.closest(`[data-slot="input-otp"]`)||document;return Array.from(e.querySelectorAll(`input[data-slot="input-otp-slot"]`))},n=n=>{if(n.target.value=n.target.value.replace(/[^0-9a-zA-Z]/g,``).slice(-1),n.target.value){let n=t(),r=n.indexOf(e);n[r+1]&&n[r+1].focus()}},r=n=>{if(n.key===`Backspace`&&!n.target.value){let n=t(),r=n.indexOf(e);n[r-1]&&n[r-1].focus()}},i=n=>{n.preventDefault();let r=(n.clipboardData||window.clipboardData).getData(`text`).replace(/[^0-9a-zA-Z]/g,``);if(!r)return;let i=t(),a=i.indexOf(e);r.split(``).forEach((e,t)=>{i[a+t]&&(i[a+t].value=e)});let o=i[Math.min(a+r.length,i.length-1)];o&&o.focus()};return e.addEventListener(`input`,n),e.addEventListener(`keydown`,r),e.addEventListener(`paste`,i),()=>{e.removeEventListener(`input`,n),e.removeEventListener(`keydown`,r),e.removeEventListener(`paste`,i)}}),l=olum.mkElm(`div`,`InputOTPSlot`,`l6dhlshb18h`),u=l,f={classes:s},p={__style__(){return``},methods:{},props:{},compName:`InputOTPSlot`,deps:null,components:{},get getElm(){var e=l.isConnected?olum.vdom.mkStaging(l):l;return e.innerHTML=`
      <input type="text" inputmode="numeric" autocomplete="one-time-code" maxlength="1" data-slot="input-otp-slot" data-index="${olum.esc(n.index===void 0?0:n.index)}" class="${olum.esc(s())}">`,olum.injectStyle(`InputOTPSlot`,p.__style__()),olum.handleMarkup(`InputOTPSlot`,`l6dhlshb18h`,e,f)}};return{methods:p.methods,props:p.props,__OLUM__:p,el:l,methodsRef:f,stateProps:null,localsRef:{get base(){return a}},hooks:{mounted:c===void 0?null:c,unMounted:null,isMounted:!1,isUnMounted:!1}}},ua=e=>{let t=e||`NativeSelect`,n=d(t),{size:r=`default`,disabled:i=!1,value:a,defaultValue:o,name:s,id:c,class:l=``,onchange:u,children:f}=d(t),p=e=>n.onchange&&n.onchange(e),m=()=>q(`group/native-select relative w-fit has-[select:disabled]:opacity-50`,n.class===void 0?``:n.class),h=`h-8 w-full min-w-0 appearance-none rounded-lg border border-border bg-background py-1 pr-8 pl-2.5 text-sm transition-colors outline-none select-none selection:bg-primary selection:text-primary-foreground placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:cursor-not-allowed aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 data-[size=sm]:h-7 data-[size=sm]:rounded-[min(var(--radius-md),10px)] data-[size=sm]:py-0.5`;var g=olum.mkElm(`div`,`NativeSelect`,`lcho4s5w77j`),_={handleChange:p,wrapperClasses:m},v={__style__(){return``},methods:{},props:{},compName:`NativeSelect`,deps:null,components:{},get getElm(){var e=g.isConnected?olum.vdom.mkStaging(g):g;return e.innerHTML=`
...
</div>`,olum.injectStyle(`NativeSelect`,v.__style__()),olum.handleMarkup(`NativeSelect`,`lcho4s5w77j`,e,_)}};return{methods:v.methods,props:v.props,__OLUM__:v,el:g,methodsRef:_,stateProps:null,localsRef:{get base(){return h}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},da=e=>{let t=e||`NativeSelectOptGroup`,n=d(t),{label:r,class:i=``,children:a}=d(t),o=()=>q(`bg-[Canvas] text-[CanvasText]`,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`NativeSelectOptGroup`,`ko9hq8431g`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`NativeSelectOptGroup`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <optgroup data-slot="native-select-optgroup" label="${olum.esc(n.label)}" class="${olum.esc(o())}">${n.children}</optgroup>`,olum.injectStyle(`NativeSelectOptGroup`,l.__style__()),olum.handleMarkup(`NativeSelectOptGroup`,`ko9hq8431g`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},fa=e=>{let t=e||`NativeSelectOption`,n=d(t),{value:r,class:i=``,children:a}=d(t),o=()=>q(`bg-[Canvas] text-[CanvasText]`,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`NativeSelectOption`,`12m1fyh73sho`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`NativeSelectOption`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <option data-slot="native-select-option" value="${olum.esc(n.value)}" class="${olum.esc(o())}">${n.children}</option>`,olum.injectStyle(`NativeSelectOption`,l.__style__()),olum.handleMarkup(`NativeSelectOption`,`12m1fyh73sho`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},pa=e=>{let t=e||`RadioGroup`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`grid w-full gap-2`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`RadioGroup`,`qj8j5dv5vld`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`RadioGroup`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div role="radiogroup" data-slot="radio-group" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`RadioGroup`,c.__style__()),olum.handleMarkup(`RadioGroup`,`qj8j5dv5vld`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ma=e=>{let t=e||`RadioGroupItem`,n=d(t),{name:r=`radio-group`,value:i,defaultChecked:a=!1,disabled:o=!1,id:s,class:c=``,onCheckedChange:l}=d(t),u=e=>{n.onCheckedChange&&n.onCheckedChange(n.value)},f=`peer relative flex aspect-square size-4 shrink-0 appearance-none cursor-pointer rounded-full border border-border bg-background outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 checked:border-primary checked:bg-primary`,p=()=>q(f,n.class===void 0?``:n.class);var m=olum.mkElm(`div`,`RadioGroupItem`,`8b33drb8bpi`),h={handleChange:u,classes:p},g={__style__(){return``},methods:{},props:{},compName:`RadioGroupItem`,deps:null,components:{},get getElm(){var e=m.isConnected?olum.vdom.mkStaging(m):m;return e.innerHTML=`
  ...
  <input type="checkbox" class="hidden">
  ${n.children}
</div>`,olum.injectStyle(`Select`,f.__style__()),olum.handleMarkup(`Select`,`nu4nlhrlfxm`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:s===void 0?null:s,unMounted:null,isMounted:!1,isUnMounted:!1}}},ga=e=>{let t=e||`SelectContent`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.closest(`[data-slot="select"]`),t=e&&e.querySelector(`:scope > input`),n=()=>{t&&(t.checked=!1,t.dispatchEvent(new Event(`change`,{bubbles:!0})))},r=t=>{e&&!e.contains(t.target)&&n()},i=e=>{e.key===`Escape`&&t&&t.checked&&n()};return document.addEventListener(`click`,r),document.addEventListener(`keydown`,i),()=>{document.removeEventListener(`click`,r),document.removeEventListener(`keydown`,i)}});let s=()=>q(`absolute top-full left-0 z-50 mt-1 max-h-72 w-full min-w-36 overflow-x-hidden overflow-y-auto rounded-lg bg-background text-foreground shadow-md ring-1 ring-border outline-none`,n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`SelectContent`,`kp2hscbnlg`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`SelectContent`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <div data-slot="select-content" class="${olum.esc(s())}">${n.children}</div>`,olum.injectStyle(`SelectContent`,f.__style__()),olum.handleMarkup(`SelectContent`,`kp2hscbnlg`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},_a=e=>{let t=e||`SelectGroup`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`scroll-my-1 p-1`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SelectGroup`,`3gs87mmwp6a`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`SelectGroup`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="select-group" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`SelectGroup`,c.__style__()),olum.handleMarkup(`SelectGroup`,`3gs87mmwp6a`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},va=e=>{let t=e||`SelectItem`,n=d(t),{value:r,disabled:i=!1,class:a=``,children:o}=d(t),s=`relative flex w-full cursor-default items-center gap-1.5 rounded-md py-1 pr-8 pl-1.5 text-sm outline-none select-none hover:bg-muted disabled:pointer-events-none disabled:opacity-50 [&[data-checked]_[data-slot=select-item-indicator]]:flex [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,c=()=>q(s,n.class===void 0?``:n.class);var l=olum.mkElm(`div`,`SelectItem`,`dgbiai8sx4l`),u={classes:c},f={__style__(){return``},methods:{},props:{},compName:`SelectItem`,deps:null,components:{},get getElm(){var e=l.isConnected?olum.vdom.mkStaging(l):l;return e.innerHTML=`
...
</button>`,olum.injectStyle(`SelectItem`,f.__style__()),olum.handleMarkup(`SelectItem`,`dgbiai8sx4l`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:l,methodsRef:u,stateProps:null,localsRef:{get base(){return s}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ya=e=>{let t=e||`SelectLabel`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`px-1.5 py-1 text-xs text-muted-foreground`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SelectLabel`,`r9v1pzahhyd`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`SelectLabel`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="select-label" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`SelectLabel`,c.__style__()),olum.handleMarkup(`SelectLabel`,`r9v1pzahhyd`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ba=e=>{let t=e||`SelectSeparator`,n=d(t),{class:r=``}=d(t),i=()=>q(`pointer-events-none -mx-1 my-1 h-px bg-border`,n.class===void 0?``:n.class);var a=olum.mkElm(`div`,`SelectSeparator`,`b00hfd95x56`),o={classes:i},s={__style__(){return``},methods:{},props:{},compName:`SelectSeparator`,deps:null,components:{},get getElm(){var e=a.isConnected?olum.vdom.mkStaging(a):a;return e.innerHTML=`
      <div data-slot="select-separator" class="${olum.esc(i())}"></div>`,olum.injectStyle(`SelectSeparator`,s.__style__()),olum.handleMarkup(`SelectSeparator`,`b00hfd95x56`,e,o)}};return{methods:s.methods,props:s.props,__OLUM__:s,el:a,methodsRef:o,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},xa=e=>{let t=e||`SelectTrigger`,n=d(t),{size:r=`default`,disabled:i=!1,class:a=``,children:s}=d(t);var c=o(()=>{let e=m.closest(`[data-slot="select"]`),t=e&&e.querySelector(`:scope > input`),n=m.querySelector(`button`),r=()=>{t&&(t.checked=!t.checked,t.dispatchEvent(new Event(`change`,{bubbles:!0})))};return n.addEventListener(`click`,r),()=>n.removeEventListener(`click`,r)});let l=`flex w-fit items-center justify-between gap-1.5 rounded-lg border border-border bg-transparent py-2 pr-2 pl-2.5 text-sm whitespace-nowrap transition-colors outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 [&>[data-olum]]:contents [&_[data-slot=select-value]]:line-clamp-1 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,u={default:`h-8`,sm:`h-7 rounded-[min(var(--radius-md),10px)]`},f=()=>q(l,u[n.size===void 0?`default`:n.size]||u.default,n.class===void 0?``:n.class);var p=olum.mkElm(`div`,`SelectTrigger`,`r3qapqp98f`),m=p,h={classes:f},g={__style__(){return``},methods:{},props:{},compName:`SelectTrigger`,deps:null,components:{},get getElm(){var e=p.isConnected?olum.vdom.mkStaging(p):p;return e.innerHTML=`
...
</button>`,olum.injectStyle(`SelectTrigger`,g.__style__()),olum.handleMarkup(`SelectTrigger`,`r3qapqp98f`,e,h)}};return{methods:g.methods,props:g.props,__OLUM__:g,el:p,methodsRef:h,stateProps:null,localsRef:{get base(){return l},get sizes(){return u}},hooks:{mounted:c===void 0?null:c,unMounted:null,isMounted:!1,isUnMounted:!1}}},Sa=e=>{let t=e||`SelectValue`,n=d(t),{placeholder:r=``,class:i=``}=d(t),a=()=>q(`flex flex-1 text-left data-[placeholder]:text-muted-foreground`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SelectValue`,`xxjwofe4fsd`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`SelectValue`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <span data-slot="select-value" data-placeholder="" class="${olum.esc(a())}">${olum.esc(n.placeholder===void 0?``:n.placeholder)}</span>`,olum.injectStyle(`SelectValue`,c.__style__()),olum.handleMarkup(`SelectValue`,`xxjwofe4fsd`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ca=e=>{let t=e||`Slider`,n=d(t),{defaultValue:r,value:i,min:a=0,max:o=100,step:s=1,disabled:c=!1,class:l=``}=d(t),u=Array.isArray(n.value)?n.value:Array.isArray(n.defaultValue)?n.defaultValue:[n.min===void 0?0:n.min,n.max===void 0?100:n.max];var f={values:u.slice()};let p=e=>(e-(n.min===void 0?0:n.min))/((n.max===void 0?100:n.max)-(n.min===void 0?0:n.min))*100,m=()=>f.values.length>1?p(Math.min(...f.values)):0,h=()=>p(Math.max(...f.values)),g=(e,t)=>{f.values[e]=+t.target.value},_=()=>f.values.length>1,v=()=>q(`peer absolute inset-0 h-4 w-full cursor-pointer appearance-none bg-transparent opacity-0 [&::-webkit-slider-thumb]:size-3 [&::-webkit-slider-thumb]:appearance-none [&::-moz-range-thumb]:size-3`,_()?`pointer-events-none [&::-webkit-slider-thumb]:pointer-events-auto [&::-moz-range-thumb]:pointer-events-auto`:``),y=()=>q(`relative flex w-full touch-none items-center select-none`,n.class===void 0?``:n.class),b=(e,t)=>(e=>g(t,e))(e);var x=olum.mkElm(`div`,`Slider`,`wuihz1180s`),S={pct:p,rangeStart:m,rangeEnd:h,handleInput:g,isRange:_,inputClasses:v,classes:y,__olumAnon_4z0jyg6:b},C={__style__(){return``},methods:{},props:{},compName:`Slider`,deps:null,components:{},get getElm(){var e=x.isConnected?olum.vdom.mkStaging(x):x;return e.innerHTML=`
  ...
  ${f.values.map(function(e,t){return`
    <div class="contents" key="${olum.esc(t)}">
      <input type="range" min="${olum.esc(n.min===void 0?0:n.min)}" max="${olum.esc(n.max===void 0?100:n.max)}" step="${olum.esc(n.step===void 0?1:n.step)}" value="${olum.esc(e)}" ${n.disabled!==void 0&&n.disabled?`disabled`:``} class="${olum.esc(v())}" data-o-event='oninput|__olumAnon_4z0jyg6=${JSON.stringify([`$event`,t])}'>
  ...
  `}).join(``)}
</div>`,olum.injectStyle(`Slider`,C.__style__()),olum.handleMarkup(`Slider`,`wuihz1180s`,e,S)}};return f.__olum__={compName:t,compId:`wuihz1180s`},f=olum.proxyHandler(f,null,x),{methods:C.methods,props:C.props,__OLUM__:C,el:x,methodsRef:S,stateProps:f,localsRef:{get initial(){return u}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},wa=e=>{let t=e||`Switch`,n=d(t),{defaultChecked:r=!1,checked:i,disabled:a=!1,size:o=`default`,id:s,name:c,class:l=``,onCheckedChange:u}=d(t);var f={checked:n.checked===void 0?n.defaultChecked!==void 0&&n.defaultChecked:n.checked};let p=e=>{f.checked=e.target.checked,n.onCheckedChange&&n.onCheckedChange(e.target.checked)},m=`peer relative inline-flex shrink-0 appearance-none cursor-pointer items-center rounded-full border border-transparent bg-muted-foreground/30 transition-colors outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 checked:bg-primary`,h={default:`h-[18.4px] w-[32px]`,sm:`h-[14px] w-[24px]`},g={default:`size-4 left-px peer-checked:translate-x-[calc(100%-2px)]`,sm:`size-3 left-px peer-checked:translate-x-[calc(100%-2px)]`},_=()=>q(m,h[n.size===void 0?`default`:n.size]||h.default,n.class===void 0?``:n.class),v=()=>q(`pointer-events-none absolute top-1/2 block -translate-y-1/2 translate-x-0 rounded-full bg-background ring-0 transition-transform`,g[n.size===void 0?`default`:n.size]||g.default);var y=olum.mkElm(`div`,`Switch`,`6ho0317ta7c`),b={handleChange:p,classes:_,thumbClasses:v},x={__style__(){return``},methods:{},props:{},compName:`Switch`,deps:null,components:{},get getElm(){var e=y.isConnected?olum.vdom.mkStaging(y):y;return e.innerHTML=`
...
</span>`,olum.injectStyle(`Switch`,x.__style__()),olum.handleMarkup(`Switch`,`6ho0317ta7c`,e,b)}};return f.__olum__={compName:t,compId:`6ho0317ta7c`},f=olum.proxyHandler(f,null,y),{methods:x.methods,props:x.props,__OLUM__:x,el:y,methodsRef:b,stateProps:f,localsRef:{get base(){return m},get sizes(){return h},get thumbSizes(){return g}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ta=e=>{let t=e||`Textarea`,n=d(t),{class:r=``,disabled:i=!1,required:a=!1,readonly:o=!1,invalid:s=!1,placeholder:c,value:l,name:u,id:f,rows:p,oninput:m,onchange:h,onfocus:g,onblur:_}=d(t),v=`flex field-sizing-content min-h-16 w-full rounded-lg border border-border bg-background px-2.5 py-2 text-sm text-foreground transition-colors outline-none placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20`,y=()=>q(v,n.class===void 0?``:n.class),b=e=>n.oninput&&n.oninput(e),x=e=>n.onchange&&n.onchange(e),S=e=>n.onfocus&&n.onfocus(e),C=e=>n.onblur&&n.onblur(e);var w=olum.mkElm(`div`,`Textarea`,`zvw7kw17erf`),T={classes:y,handleInput:b,handleChange:x,handleFocus:S,handleBlur:C},E={__style__(){return``},methods:{},props:{},compName:`Textarea`,deps:null,components:{},get getElm(){var e=w.isConnected?olum.vdom.mkStaging(w):w;return e.innerHTML=`
      <textarea class="${olum.esc(y())}" placeholder="${olum.esc(n.placeholder)}" name="${olum.esc(n.name)}" id="${olum.esc(n.id)}" rows="${olum.esc(n.rows)}" ${n.disabled!==void 0&&n.disabled?`disabled`:``} ${n.required!==void 0&&n.required?`required`:``} ${n.readonly!==void 0&&n.readonly?`readonly`:``} aria-invalid="${olum.esc(n.invalid!==void 0&&n.invalid)}" data-o-event='onblur|handleBlur=${JSON.stringify([])}OLUM_EVT_SEPonchange|handleChange=${JSON.stringify([])}OLUM_EVT_SEPonfocus|handleFocus=${JSON.stringify([])}OLUM_EVT_SEPoninput|handleInput=${JSON.stringify([])}'>${olum.esc(n.value)}</textarea>`,olum.injectStyle(`Textarea`,E.__style__()),olum.handleMarkup(`Textarea`,`zvw7kw17erf`,e,T)}};return{methods:E.methods,props:E.props,__OLUM__:E,el:w,methodsRef:T,stateProps:null,localsRef:{get base(){return v}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ea=e=>{let t=e||`Toggle`,n=d(t),{variant:r=`default`,size:i=`default`,defaultPressed:a=!1,pressed:o,disabled:s=!1,class:c=``,onPressedChange:l,children:u}=d(t),f=()=>n.pressed!==void 0;var p={pressed:n.defaultPressed!==void 0&&n.defaultPressed};let m=()=>f()?n.pressed:p.pressed,h=()=>{let e=!m();f()||(p.pressed=e),n.onPressedChange&&n.onPressedChange(e)},g=`group/toggle inline-flex items-center justify-center gap-1 rounded-lg text-sm font-medium whitespace-nowrap transition-all outline-none hover:bg-muted hover:text-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 aria-pressed:bg-muted [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,_={default:`bg-transparent`,outline:`border border-border bg-transparent hover:bg-muted`},v={default:`h-8 min-w-8 px-2.5 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2`,sm:`h-7 min-w-7 rounded-[min(var(--radius-md),12px)] px-2.5 text-[0.8rem] has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&_svg:not([class*='size-'])]:size-3.5`,lg:`h-9 min-w-9 px-2.5 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2`},y=()=>q(g,_[n.variant===void 0?`default`:n.variant]||_.default,v[n.size===void 0?`default`:n.size]||v.default,n.class===void 0?``:n.class);var b=olum.mkElm(`div`,`Toggle`,`ch3kp2lt98`),x={isControlled:f,isPressed:m,handleClick:h,classes:y},S={__style__(){return``},methods:{},props:{},compName:`Toggle`,deps:null,components:{},get getElm(){var e=b.isConnected?olum.vdom.mkStaging(b):b;return e.innerHTML=`
      <button data-slot="toggle" type="button" aria-pressed="${olum.esc(m())}" ${n.disabled!==void 0&&n.disabled?`disabled`:``} class="${olum.esc(y())}" data-o-event='onclick|handleClick=${JSON.stringify([])}'>${n.children}</button>`,olum.injectStyle(`Toggle`,S.__style__()),olum.handleMarkup(`Toggle`,`ch3kp2lt98`,e,x)}};return p.__olum__={compName:t,compId:`ch3kp2lt98`},p=olum.proxyHandler(p,null,b),{methods:S.methods,props:S.props,__OLUM__:S,el:b,methodsRef:x,stateProps:p,localsRef:{get base(){return g},get variants(){return _},get sizes(){return v}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Da=0;function Oa(){return`toggle-group-${Da++}`}var ka=f({active:{},init(e,t){this.active[e]||(this.active={...this.active,[e]:new Set(t)})},isActive(e,t){let n=this.active[e];return!!n&&n.has(t)},toggle(e,t,n){let r=this.active[e]||new Set,i=n?new Set(r):new Set;n&&i.has(t)?i.delete(t):i.add(t),this.active={...this.active,[e]:i}}}),Aa=e=>{let t=e||`ToggleGroup`,n=d(t),{multiple:r=!1,defaultValue:i=[],orientation:a=`horizontal`,class:o=``,children:s}=d(t),c=Oa();ka.init(c,n.defaultValue===void 0?[]:n.defaultValue);let l=`group/toggle-group flex w-fit items-center gap-2 rounded-lg`,u={horizontal:`flex-row`,vertical:`flex-col items-stretch`},f=()=>q(l,u[n.orientation===void 0?`horizontal`:n.orientation]||u.horizontal,n.class===void 0?``:n.class);var p=olum.mkElm(`div`,`ToggleGroup`,`ab13nkleqyg`),m={classes:f},h={__style__(){return``},methods:{},props:{},compName:`ToggleGroup`,deps:null,components:{},get getElm(){var e=p.isConnected?olum.vdom.mkStaging(p):p;return e.innerHTML=`
      <div role="group" data-slot="toggle-group" data-group-id="${olum.esc(c)}" data-multiple="${olum.esc(n.multiple!==void 0&&n.multiple)}" data-orientation="${olum.esc(n.orientation===void 0?`horizontal`:n.orientation)}" class="${olum.esc(f())}">${n.children}</div>`,olum.injectStyle(`ToggleGroup`,h.__style__()),olum.handleMarkup(`ToggleGroup`,`ab13nkleqyg`,e,m)}};return{methods:h.methods,props:h.props,__OLUM__:h,el:p,methodsRef:m,stateProps:null,localsRef:{get base(){return l},get orientations(){return u}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ja=e=>{let t=e||`ToggleGroupItem`,n=d(t),{value:r,variant:i=`default`,size:a=`default`,class:s=``,children:c}=d(t);var l={groupId:null,multiple:!1},u=o(()=>{let e=g.closest(`[data-slot="toggle-group"]`);e&&(l.groupId=e.dataset.groupId,l.multiple=e.dataset.multiple===`true`)});let f=()=>l.groupId!=null&&ka.isActive(l.groupId,n.value),p=()=>{l.groupId!=null&&ka.toggle(l.groupId,n.value,l.multiple)},m=()=>q(`shrink-0 focus:z-10 focus-visible:z-10`,n.class===void 0?``:n.class);var h=olum.mkElm(`div`,`ToggleGroupItem`,`f1rl0eg6b1`),g=h,_={isPressed:f,handlePressedChange:p,classes:m},v={__style__(){return``},methods:{},props:{},compName:`ToggleGroupItem`,deps:null,components:{Toggle:Ea},get getElm(){var e=h.isConnected?olum.vdom.mkStaging(h):h;return e.innerHTML=`
      <olum name="Toggle" data-o-props='${encodeURIComponent(JSON.stringify({variant:n.variant===void 0?`default`:n.variant,size:n.size===void 0?`default`:n.size,pressed:f(),class:m()})).replace(/'/g,`%27`)}' data-o-props-src="onPressedChange:method:handlePressedChange" data-o-props-owner='${t}'>${n.children}</olum>`,olum.injectStyle(`ToggleGroupItem`,v.__style__()),olum.handleMarkup(`ToggleGroupItem`,`f1rl0eg6b1`,e,_)}};return l.__olum__={compName:t,compId:`f1rl0eg6b1`},l=olum.proxyHandler(l,null,h),{methods:v.methods,props:v.props,__OLUM__:v,el:h,methodsRef:_,stateProps:l,localsRef:{},hooks:{mounted:u===void 0?null:u,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ma=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="m21 21-4.34-4.34"/><circle cx="11" cy="11" r="8"/></svg>`,Na=e=>{let t=e||`page`;var n={name:``,email:``,bio:``,country:``,plan:`pro`,notify:!0,terms:!1,termsError:!1,submitted:!1};let r=e=>n.name=e.target.value,i=e=>n.email=e.target.value,a=e=>n.bio=e.target.value,o=e=>n.country=e.target.value,s=e=>n.plan=e,c=e=>n.notify=e,l=e=>{n.terms=e,e&&(n.termsError=!1)},u=()=>{n.termsError=!n.terms,n.submitted=n.terms},d={framework:`olum`,otp:``,searchQuery:``},f=e=>d.framework=e,p=e=>d.searchQuery=e.target.value,m=()=>d.searchQuery=``,h=[`Apple`,`Banana`,`Cherry`,`Durian`,`Elderberry`,`Fig`,`Grape`,`Honeydew`];var g=olum.mkElm(`div`,`page`,`gvp5awa3bou`),_={onNameInput:r,onEmailInput:i,onBioInput:a,onCountryChange:o,onPlanChange:s,onNotifyChange:c,onTermsChange:l,submitForm:u,onFrameworkChange:f,onSearchInput:p,clearSearch:m},v={__style__(){return``},methods:{},props:{},compName:`page`,deps:null,components:{Nav:X,FeatureSidebar:Z,SiteFooter:Q,Button:J,Icon:Y,ButtonGroup:zi,ButtonGroupSeparator:Bi,ButtonGroupText:Vi,Calendar:Hi,Checkbox:Ui,Combobox:Wi,DatePicker:Gi,Field:Ki,FieldContent:qi,FieldDescription:Ji,FieldError:Yi,FieldGroup:Xi,FieldLabel:Qi,FieldLegend:$i,FieldSeparator:ea,FieldSet:ta,Input:yt,InputGroup:na,InputGroupAddon:ra,InputGroupButton:ia,InputGroupInput:aa,InputOTP:oa,InputOTPGroup:sa,InputOTPSeparator:ca,InputOTPSlot:la,Label:Zi,NativeSelect:ua,NativeSelectOptGroup:da,NativeSelectOption:fa,RadioGroup:pa,RadioGroupItem:ma,Select:ha,SelectContent:ga,SelectGroup:_a,SelectItem:va,SelectLabel:ya,SelectSeparator:ba,SelectTrigger:xa,SelectValue:Sa,Slider:Ca,Switch:wa,Textarea:Ta,Toggle:Ea,ToggleGroup:Aa,ToggleGroupItem:ja},get getElm(){var e=g.isConnected?olum.vdom.mkStaging(g):g;return e.innerHTML=`
      <olum name="Nav"></olum>
    ...
    <div class="flex flex-col gap-6 rounded-xl border border-border p-6">
      <olum name="InputGroup" data-o-props='${encodeURIComponent(JSON.stringify({class:`max-w-xs`})).replace(/'/g,`%27`)}'>
        <olum name="InputGroupAddon">
          <olum name="Icon" data-o-props='${encodeURIComponent(JSON.stringify({icon:Ma,class:`size-4`})).replace(/'/g,`%27`)}'></olum>
        </olum>
...
<olum name="SiteFooter"></olum>`,olum.injectStyle(`page`,v.__style__()),olum.handleMarkup(`page`,`gvp5awa3bou`,e,_)}};return n.__olum__={compName:t,compId:`gvp5awa3bou`},n=olum.proxyHandler(n,null,g),{methods:v.methods,props:v.props,__OLUM__:v,el:g,methodsRef:_,stateProps:n,localsRef:{get gallery(){return d},get fruits(){return h}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Pa=e=>{let t=e||`AspectRatio`,n=d(t),{ratio:r=1,class:i=``,children:a}=d(t),o=()=>q(`relative`,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`AspectRatio`,`jdl67lbtg0b`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`AspectRatio`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
  ...
  `:``}
</div>`,olum.injectStyle(`ResizableHandle`,f.__style__()),olum.handleMarkup(`ResizableHandle`,`xopdbqx9xc`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},za=e=>{let t=e||`ScrollArea`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`relative`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`ScrollArea`,`a0x3hmzydqc`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`ScrollArea`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
...
</div>`,olum.injectStyle(`ScrollArea`,c.__style__()),olum.handleMarkup(`ScrollArea`,`a0x3hmzydqc`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ba=e=>{let t=e||`Direction`,n=d(t),{direction:r=`ltr`,children:i}=d(t);var a=olum.mkElm(`div`,`Direction`,`8i3lds3znka`),o={},s={__style__(){return``},methods:{},props:{},compName:`Direction`,deps:null,components:{},get getElm(){var e=a.isConnected?olum.vdom.mkStaging(a):a;return e.innerHTML=`
      <div data-slot="direction-provider" dir="${olum.esc(n.direction===void 0?`ltr`:n.direction)}" class="contents">${n.children}</div>`,olum.injectStyle(`Direction`,s.__style__()),olum.handleMarkup(`Direction`,`8i3lds3znka`,e,o)}};return{methods:s.methods,props:s.props,__OLUM__:s,el:a,methodsRef:o,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Va=e=>{let t=e||`SidebarProvider`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`group/sidebar-wrapper relative flex min-h-svh w-full [--sidebar-width:16rem] [--sidebar-width-icon:3rem] [&>[data-olum]]:contents`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SidebarProvider`,`65cv5uhyam4`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`SidebarProvider`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="sidebar-wrapper" data-state="expanded" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`SidebarProvider`,c.__style__()),olum.handleMarkup(`SidebarProvider`,`65cv5uhyam4`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ha=e=>{let t=e||`Sidebar`,n=d(t),{side:r=`left`,collapsible:i=`icon`,class:a=``,children:o}=d(t),s=()=>q(`absolute inset-y-0 left-0 z-10 flex h-full w-(--sidebar-width) flex-col border-r border-border bg-background text-foreground transition-[width] duration-200 ease-linear group-data-[state=collapsed]/sidebar-wrapper:w-(--sidebar-width-icon)`,n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`Sidebar`,`v0cbxcxc35r`),l={classes:s},u={__style__(){return``},methods:{},props:{},compName:`Sidebar`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
...
<div data-slot="sidebar" data-side="${olum.esc(n.side===void 0?`left`:n.side)}" data-collapsible="${olum.esc(n.collapsible===void 0?`icon`:n.collapsible)}" class="${olum.esc(s())}">${n.children}</div>`,olum.injectStyle(`Sidebar`,u.__style__()),olum.handleMarkup(`Sidebar`,`v0cbxcxc35r`,e,l)}};return{methods:u.methods,props:u.props,__OLUM__:u,el:c,methodsRef:l,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ua=e=>{let t=e||`SidebarHeader`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`flex flex-col gap-2 p-2`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SidebarHeader`,`1spt3z6uz24`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`SidebarHeader`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="sidebar-header" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`SidebarHeader`,c.__style__()),olum.handleMarkup(`SidebarHeader`,`1spt3z6uz24`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Wa=e=>{let t=e||`SidebarContent`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`flex min-h-0 flex-1 flex-col gap-0 overflow-auto [scrollbar-width:none] group-data-[state=collapsed]/sidebar-wrapper:overflow-hidden`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SidebarContent`,`1b1doyt4c5h`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`SidebarContent`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="sidebar-content" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`SidebarContent`,c.__style__()),olum.handleMarkup(`SidebarContent`,`1b1doyt4c5h`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ga=e=>{let t=e||`SidebarFooter`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`flex flex-col gap-2 p-2`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SidebarFooter`,`z5vmeoeqtp`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`SidebarFooter`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="sidebar-footer" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`SidebarFooter`,c.__style__()),olum.handleMarkup(`SidebarFooter`,`z5vmeoeqtp`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ka=e=>{let t=e||`SidebarGroup`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`relative flex w-full min-w-0 flex-col p-2`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SidebarGroup`,`lxxm5lmb6cr`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`SidebarGroup`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="sidebar-group" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`SidebarGroup`,c.__style__()),olum.handleMarkup(`SidebarGroup`,`lxxm5lmb6cr`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},qa=e=>{let t=e||`SidebarGroupLabel`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-foreground/70 outline-none transition-[margin,opacity] duration-200 ease-linear group-data-[state=collapsed]/sidebar-wrapper:-mt-8 group-data-[state=collapsed]/sidebar-wrapper:opacity-0 [&>svg]:size-4 [&>svg]:shrink-0`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SidebarGroupLabel`,`hzp4zes1v3e`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`SidebarGroupLabel`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="sidebar-group-label" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`SidebarGroupLabel`,c.__style__()),olum.handleMarkup(`SidebarGroupLabel`,`hzp4zes1v3e`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ja=e=>{let t=e||`SidebarGroupContent`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`w-full text-sm`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SidebarGroupContent`,`zi0mmv2yaup`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`SidebarGroupContent`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="sidebar-group-content" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`SidebarGroupContent`,c.__style__()),olum.handleMarkup(`SidebarGroupContent`,`zi0mmv2yaup`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ya=e=>{let t=e||`SidebarMenu`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`flex w-full min-w-0 flex-col gap-0`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SidebarMenu`,`0837i802q3rb`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`SidebarMenu`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="sidebar-menu" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`SidebarMenu`,c.__style__()),olum.handleMarkup(`SidebarMenu`,`0837i802q3rb`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Xa=e=>{let t=e||`SidebarMenuItem`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`group/menu-item relative`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SidebarMenuItem`,`6s23prerof8`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`SidebarMenuItem`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="sidebar-menu-item" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`SidebarMenuItem`,c.__style__()),olum.handleMarkup(`SidebarMenuItem`,`6s23prerof8`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Za=e=>{let t=e||`SidebarMenuButton`,n=d(t),{isActive:r=!1,tooltip:i,onclick:a,class:o=``,children:s}=d(t),c=e=>n.onclick&&n.onclick(e),l=()=>q(`peer/menu-button flex h-8 w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none transition-[width,height,padding] hover:bg-muted hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring/50 active:bg-muted disabled:pointer-events-none disabled:opacity-50 data-[active=true]:bg-muted data-[active=true]:font-medium group-data-[state=collapsed]/sidebar-wrapper:size-8! group-data-[state=collapsed]/sidebar-wrapper:p-2! [&_svg]:size-4 [&_svg]:shrink-0 [&>span:last-child]:truncate`,n.class===void 0?``:n.class);var u=olum.mkElm(`div`,`SidebarMenuButton`,`wcogqxnlepn`),f={handleClick:c,classes:l},p={__style__(){return``},methods:{},props:{},compName:`SidebarMenuButton`,deps:null,components:{},get getElm(){var e=u.isConnected?olum.vdom.mkStaging(u):u;return e.innerHTML=`
      <button type="button" data-slot="sidebar-menu-button" data-active="${olum.esc(n.isActive!==void 0&&n.isActive)}" title="${olum.esc(n.tooltip)}" class="${olum.esc(l())}" data-o-event='onclick|handleClick=${JSON.stringify([])}'>${n.children}</button>`,olum.injectStyle(`SidebarMenuButton`,p.__style__()),olum.handleMarkup(`SidebarMenuButton`,`wcogqxnlepn`,e,f)}};return{methods:p.methods,props:p.props,__OLUM__:p,el:u,methodsRef:f,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Qa=e=>{let t=e||`SidebarSeparator`,n=d(t),{class:r=``}=d(t),i=()=>q(`mx-2 h-px w-auto shrink-0 bg-border`,n.class===void 0?``:n.class);var a=olum.mkElm(`div`,`SidebarSeparator`,`3k8s9d64c69`),o={classes:i},s={__style__(){return``},methods:{},props:{},compName:`SidebarSeparator`,deps:null,components:{},get getElm(){var e=a.isConnected?olum.vdom.mkStaging(a):a;return e.innerHTML=`
      <div data-slot="sidebar-separator" class="${olum.esc(i())}"></div>`,olum.injectStyle(`SidebarSeparator`,s.__style__()),olum.handleMarkup(`SidebarSeparator`,`3k8s9d64c69`,e,o)}};return{methods:s.methods,props:s.props,__OLUM__:s,el:a,methodsRef:o,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},$a=e=>{let t=e||`SidebarInset`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`relative flex h-full w-full flex-1 flex-col bg-background`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SidebarInset`,`e43dwwak41q`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`SidebarInset`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <main data-slot="sidebar-inset" class="${olum.esc(a())}">${n.children}</main>`,olum.injectStyle(`SidebarInset`,c.__style__()),olum.handleMarkup(`SidebarInset`,`e43dwwak41q`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},eo=e=>{let t=e||`SidebarTrigger`,n=d(t),{class:r=``}=d(t),i=()=>{let e=s.closest(`[data-slot="sidebar-wrapper"]`);e&&e.setAttribute(`data-state`,e.getAttribute(`data-state`)===`collapsed`?`expanded`:`collapsed`)},a=()=>q(`inline-flex size-7 shrink-0 items-center justify-center rounded-[min(var(--radius-md),12px)] border border-transparent text-foreground transition-all outline-none select-none hover:bg-muted focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 [&_svg]:size-4 [&_svg]:shrink-0`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SidebarTrigger`,`szjwse498s`),s=o,c={toggle:i,classes:a},l={__style__(){return``},methods:{},props:{},compName:`SidebarTrigger`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
...
</button>`,olum.injectStyle(`SidebarTrigger`,l.__style__()),olum.handleMarkup(`SidebarTrigger`,`szjwse498s`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:o,methodsRef:c,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},to=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915"/><circle cx="12" cy="12" r="3"/></svg>`,no=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.12 2.12 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.12 2.12 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.12 2.12 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.12 2.12 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.12 2.12 0 0 0 1.597-1.16z"/></svg>`,ro=e=>{let t=e||`page`;var n={rtl:!1};let r=()=>n.rtl=!n.rtl,i=Array.from({length:20},(e,t)=>`Row ${t+1} — scrollable content inside a fixed-height ScrollArea.`);var a=olum.mkElm(`div`,`page`,`chedzc26ugh`),o={toggleRtl:r},s={__style__(){return``},methods:{},props:{},compName:`page`,deps:null,components:{Nav:X,FeatureSidebar:Z,SiteFooter:Q,AspectRatio:Pa,Card:At,CardHeader:jt,CardTitle:Mt,CardDescription:Nt,CardAction:Fa,CardContent:Tn,CardFooter:ln,Button:J,ResizablePanelGroup:Ia,ResizablePanel:La,ResizableHandle:Ra,ScrollArea:za,Separator:Qr,Direction:Ba,SidebarProvider:Va,Sidebar:Ha,SidebarHeader:Ua,SidebarContent:Wa,SidebarFooter:Ga,SidebarGroup:Ka,SidebarGroupLabel:qa,SidebarGroupContent:Ja,SidebarMenu:Ya,SidebarMenuItem:Xa,SidebarMenuButton:Za,SidebarSeparator:Qa,SidebarInset:$a,SidebarTrigger:eo,Icon:Y},get getElm(){var e=a.isConnected?olum.vdom.mkStaging(a):a;return e.innerHTML=`
      <olum name="Nav"></olum>
      ...
      <olum name="Card" data-o-props='${encodeURIComponent(JSON.stringify({class:`max-w-sm`})).replace(/'/g,`%27`)}'>
        <olum name="CardHeader">
          ...
          <olum name="CardAction">
            <olum name="Icon" data-o-props='${encodeURIComponent(JSON.stringify({icon:no,class:`size-4 text-muted-foreground`})).replace(/'/g,`%27`)}'></olum>
          </olum>
        </olum>
                ...
                <olum name="SidebarMenu">
                  <olum name="SidebarMenuItem">
                    <olum name="SidebarMenuButton" data-o-props='${encodeURIComponent(JSON.stringify({tooltip:`Settings`})).replace(/'/g,`%27`)}'>
                      <olum name="Icon" data-o-props='${encodeURIComponent(JSON.stringify({icon:to,class:`size-4`})).replace(/'/g,`%27`)}'></olum>
                      <span>Settings</span>
                    </olum>
                  </olum>
                </olum>
...
<olum name="SiteFooter"></olum>`,olum.injectStyle(`page`,s.__style__()),olum.handleMarkup(`page`,`chedzc26ugh`,e,o)}};return n.__olum__={compName:t,compId:`chedzc26ugh`},n=olum.proxyHandler(n,null,a),{methods:s.methods,props:s.props,__OLUM__:s,el:a,methodsRef:o,stateProps:n,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},io=e=>{let t=e||`Breadcrumb`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`Breadcrumb`,`44b4wy9x5w3`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`Breadcrumb`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <nav aria-label="breadcrumb" data-slot="breadcrumb" class="${olum.esc(a())}">${n.children}</nav>`,olum.injectStyle(`Breadcrumb`,c.__style__()),olum.handleMarkup(`Breadcrumb`,`44b4wy9x5w3`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ao=e=>{let t=e||`BreadcrumbList`,n=d(t),{class:r=``,children:i}=d(t),a=`flex flex-wrap items-center gap-1.5 text-sm wrap-break-word text-muted-foreground`,o=()=>q(a,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`BreadcrumbList`,`2dygdybld5`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`BreadcrumbList`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <ol data-slot="breadcrumb-list" class="${olum.esc(o())}">${n.children}</ol>`,olum.injectStyle(`BreadcrumbList`,l.__style__()),olum.handleMarkup(`BreadcrumbList`,`2dygdybld5`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{get base(){return a}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},oo=e=>{let t=e||`BreadcrumbItem`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`inline-flex items-center gap-1`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`BreadcrumbItem`,`ibvb4o8y7t8`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`BreadcrumbItem`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <li data-slot="breadcrumb-item" class="${olum.esc(a())}">${n.children}</li>`,olum.injectStyle(`BreadcrumbItem`,c.__style__()),olum.handleMarkup(`BreadcrumbItem`,`ibvb4o8y7t8`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},so=e=>{let t=e||`BreadcrumbLink`,n=d(t),{href:r=`#`,class:i=``,children:a}=d(t),o=()=>q(`transition-colors hover:text-foreground`,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`BreadcrumbLink`,`5me7tjwslmv`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`BreadcrumbLink`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <a data-slot="breadcrumb-link" href="${olum.esc(n.href===void 0?`#`:n.href)}" class="${olum.esc(o())}">${n.children}</a>`,olum.injectStyle(`BreadcrumbLink`,l.__style__()),olum.handleMarkup(`BreadcrumbLink`,`5me7tjwslmv`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},co=e=>{let t=e||`BreadcrumbPage`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`font-normal text-foreground`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`BreadcrumbPage`,`ili7dz69aed`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`BreadcrumbPage`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <span data-slot="breadcrumb-page" role="link" aria-disabled="true" aria-current="page" class="${olum.esc(a())}">${n.children}</span>`,olum.injectStyle(`BreadcrumbPage`,c.__style__()),olum.handleMarkup(`BreadcrumbPage`,`ili7dz69aed`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},lo=e=>{let t=e||`BreadcrumbSeparator`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`[&>svg]:size-3.5`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`BreadcrumbSeparator`,`g2r1yybuz55`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`BreadcrumbSeparator`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <li data-slot="breadcrumb-separator" role="presentation" aria-hidden="true" class="${olum.esc(a())}">
  ${n.children?`${n.children}`:`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"></path></svg>
  `}
  
</li>`,olum.injectStyle(`BreadcrumbSeparator`,c.__style__()),olum.handleMarkup(`BreadcrumbSeparator`,`g2r1yybuz55`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},uo=e=>{let t=e||`BreadcrumbEllipsis`,n=d(t),{class:r=``}=d(t),i=()=>q(`flex size-5 items-center justify-center [&>svg]:size-4`,n.class===void 0?``:n.class);var a=olum.mkElm(`div`,`BreadcrumbEllipsis`,`h9h6icsoih`),o={classes:i},s={__style__(){return``},methods:{},props:{},compName:`BreadcrumbEllipsis`,deps:null,components:{},get getElm(){var e=a.isConnected?olum.vdom.mkStaging(a):a;return e.innerHTML=`
...
</div>`,olum.injectStyle(`CommandInput`,c.__style__()),olum.handleMarkup(`CommandInput`,`cmne20b519t`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},mo=e=>{let t=e||`CommandList`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`max-h-72 scroll-py-1 overflow-x-hidden overflow-y-auto outline-none [scrollbar-width:none]`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`CommandList`,`re6r5rlp10f`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`CommandList`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="command-list" role="listbox" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`CommandList`,c.__style__()),olum.handleMarkup(`CommandList`,`re6r5rlp10f`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ho=e=>{let t=e||`CommandEmpty`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`hidden py-6 text-center text-sm`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`CommandEmpty`,`2ozkz1xqhiy`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`CommandEmpty`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="command-empty" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`CommandEmpty`,c.__style__()),olum.handleMarkup(`CommandEmpty`,`2ozkz1xqhiy`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},go=e=>{let t=e||`CommandGroup`,n=d(t),{heading:r,class:i=``,children:a}=d(t),o=()=>q(`overflow-hidden p-1 text-foreground`,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`CommandGroup`,`4vxncty85k`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`CommandGroup`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
  ...
  `:``}
  ${n.children}
</div>`,olum.injectStyle(`CommandGroup`,l.__style__()),olum.handleMarkup(`CommandGroup`,`4vxncty85k`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},_o=e=>{let t=e||`CommandItem`,n=d(t),{disabled:r=!1,onSelect:i,class:a=``,children:o}=d(t),s=()=>n.onSelect&&n.onSelect(),c=`group/command-item relative flex w-full cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none select-none hover:bg-muted hover:text-foreground data-[selected=true]:bg-accent data-[selected=true]:text-accent-foreground disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,l=()=>q(c,n.class===void 0?``:n.class);var u=olum.mkElm(`div`,`CommandItem`,`i459ggr9af`),f={handleClick:s,classes:l},p={__style__(){return``},methods:{},props:{},compName:`CommandItem`,deps:null,components:{},get getElm(){var e=u.isConnected?olum.vdom.mkStaging(u):u;return e.innerHTML=`
      <button type="button" data-slot="command-item" ${n.disabled!==void 0&&n.disabled?`disabled`:``} class="${olum.esc(l())}" data-o-event='onclick|handleClick=${JSON.stringify([])}'>${n.children}</button>`,olum.injectStyle(`CommandItem`,p.__style__()),olum.handleMarkup(`CommandItem`,`i459ggr9af`,e,f)}};return{methods:p.methods,props:p.props,__OLUM__:p,el:u,methodsRef:f,stateProps:null,localsRef:{get base(){return c}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},vo=e=>{let t=e||`CommandSeparator`,n=d(t),{class:r=``}=d(t),i=()=>q(`-mx-1 h-px bg-border`,n.class===void 0?``:n.class);var a=olum.mkElm(`div`,`CommandSeparator`,`kb3y1qbu24`),o={classes:i},s={__style__(){return``},methods:{},props:{},compName:`CommandSeparator`,deps:null,components:{},get getElm(){var e=a.isConnected?olum.vdom.mkStaging(a):a;return e.innerHTML=`
      <div data-slot="command-separator" class="${olum.esc(i())}"></div>`,olum.injectStyle(`CommandSeparator`,s.__style__()),olum.handleMarkup(`CommandSeparator`,`kb3y1qbu24`,e,o)}};return{methods:s.methods,props:s.props,__OLUM__:s,el:a,methodsRef:o,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},yo=e=>{let t=e||`CommandShortcut`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`ml-auto text-xs tracking-widest text-muted-foreground`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`CommandShortcut`,`444artj63ui`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`CommandShortcut`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <span data-slot="command-shortcut" class="${olum.esc(a())}">${n.children}</span>`,olum.injectStyle(`CommandShortcut`,c.__style__()),olum.handleMarkup(`CommandShortcut`,`444artj63ui`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},bo=e=>{let t=e||`CommandDialog`,n=d(t),{defaultOpen:r=!1,children:i}=d(t);var a=olum.mkElm(`div`,`CommandDialog`,`u5rcvr89ahg`),o={},s={__style__(){return``},methods:{},props:{},compName:`CommandDialog`,deps:null,components:{},get getElm(){var e=a.isConnected?olum.vdom.mkStaging(a):a;return e.innerHTML=`
      <div data-slot="command-dialog" class="contents">
  <input type="checkbox" class="hidden" ${n.defaultOpen!==void 0&&n.defaultOpen?`checked`:``}>
  ${n.children}
</div>`,olum.injectStyle(`CommandDialog`,s.__style__()),olum.handleMarkup(`CommandDialog`,`u5rcvr89ahg`,e,o)}};return{methods:s.methods,props:s.props,__OLUM__:s,el:a,methodsRef:o,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},xo=e=>{let t=e||`CommandDialogTrigger`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.closest(`[data-slot="command-dialog"]`),t=e&&e.querySelector(`:scope > input`),n=l.querySelector(`button`),r=()=>{t&&(t.checked=!0,t.dispatchEvent(new Event(`change`,{bubbles:!0})))};return n.addEventListener(`click`,r),()=>n.removeEventListener(`click`,r)});let s=()=>q(n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`CommandDialogTrigger`,`r8hxrzdfu7`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`CommandDialogTrigger`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <button type="button" data-slot="command-dialog-trigger" class="${olum.esc(s())}">${n.children}</button>`,olum.injectStyle(`CommandDialogTrigger`,f.__style__()),olum.handleMarkup(`CommandDialogTrigger`,`r8hxrzdfu7`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},So=`blur(4px)`,Co=0,wo=()=>document.getElementById(`app`);function To(e){return e.forEach(e=>e&&document.body.appendChild(e)),()=>e.forEach(e=>e&&e.remove())}function Eo(){if(Co+=1,Co!==1)return;let e=wo();e&&(e.style.filter=So)}function Do(){if(Co=Math.max(0,Co-1),Co!==0)return;let e=wo();e&&(e.style.filter=``)}function Oo(e,t,n){let r=e.closest(`[data-slot="${n}"]`);if(r&&r.__olumModalInput)return r.__olumModalInput;let i=e.closest(`[data-slot="${t}"]`);return i&&i.querySelector(`:scope > input`)}function ko({input:e,nodes:t,displays:n,onOpen:r,onClose:i}){document.querySelectorAll(`body > [data-olum-portal]`).forEach(t=>{let n=t.__olumPortal;n&&(n.input===e||!n.input.isConnected)&&n.dispose()});let a=To(t),o=!1,s=!1,c=()=>{let a=!!e.checked;a!==o&&(o=a,n&&t.forEach((e,t)=>{e&&(e.style.display=a?n[t]:`none`)}),a?(Eo(),r&&r()):(Do(),i&&i()))};c(),e.addEventListener(`change`,c);let l=()=>{s||(s=!0,e.removeEventListener(`change`,c),o&&Do(),a())};return t.forEach(t=>{t&&(t.setAttribute(`data-olum-portal`,``),t.__olumPortal={input:e,dispose:l})}),l}var Ao=e=>{let t=e||`CommandDialogContent`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.closest(`[data-slot="command-dialog"]`),t=e&&e.querySelector(`:scope > input`),n=l.querySelector(`[data-slot="command-dialog-overlay"]`),r=l.querySelector(`[data-slot="command-dialog-content"]`);if(!t||!n||!r)return;let i=()=>{t.checked=!1,t.dispatchEvent(new Event(`change`,{bubbles:!0}))},a=e=>{e.key===`Escape`&&t.checked&&i()},o=e=>{e.target===n&&i()},s=e=>{e.target.closest(`[data-slot=command-item]`)&&i()};n.addEventListener(`click`,o),r.addEventListener(`click`,s),document.addEventListener(`keydown`,a);let c=ko({input:t,nodes:[n,r],displays:[`block`,`block`],onOpen:()=>requestAnimationFrame(()=>{let e=r.querySelector(`[data-slot="command-input"]`);e&&(e.value=``,e.dispatchEvent(new Event(`input`,{bubbles:!0})),e.focus())})});return()=>{n.removeEventListener(`click`,o),r.removeEventListener(`click`,s),document.removeEventListener(`keydown`,a),c()}});let s=()=>q(`fixed top-1/3 left-1/2 z-50 w-full max-w-[calc(100%-2rem)] -translate-x-1/2 overflow-hidden rounded-xl bg-background p-0 text-sm text-foreground ring-1 ring-border outline-none sm:max-w-sm`,n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`CommandDialogContent`,`tfy2pagpcpq`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`CommandDialogContent`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <div data-slot="command-dialog-overlay" style="display: none" class="fixed inset-0 z-50 bg-black/20"></div>
<div data-slot="command-dialog-content" style="display: none" class="${olum.esc(s())}">${n.children}</div>`,olum.injectStyle(`CommandDialogContent`,f.__style__()),olum.handleMarkup(`CommandDialogContent`,`tfy2pagpcpq`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},jo=e=>{let t=e||`Menubar`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`flex h-8 items-center gap-0.5 rounded-lg border border-border p-[3px]`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`Menubar`,`omsfo5174hq`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`Menubar`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="menubar" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`Menubar`,c.__style__()),olum.handleMarkup(`Menubar`,`omsfo5174hq`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Mo=e=>{let t=e||`MenubarMenu`,n=d(t),{children:r}=d(t);var i=olum.mkElm(`div`,`MenubarMenu`,`j39cdr807wi`),a={},o={__style__(){return``},methods:{},props:{},compName:`MenubarMenu`,deps:null,components:{DropdownMenu:Pr},get getElm(){var e=i.isConnected?olum.vdom.mkStaging(i):i;return e.innerHTML=`
      <olum name="DropdownMenu">${n.children}</olum>`,olum.injectStyle(`MenubarMenu`,o.__style__()),olum.handleMarkup(`MenubarMenu`,`j39cdr807wi`,e,a)}};return{methods:o.methods,props:o.props,__OLUM__:o,el:i,methodsRef:a,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},No=e=>{let t=e||`MenubarTrigger`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`flex items-center rounded-sm px-1.5 py-[2px] text-sm font-medium outline-none select-none hover:bg-muted`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`MenubarTrigger`,`jvaqjk6ura9`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`MenubarTrigger`,deps:null,components:{DropdownMenuTrigger:Fr},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <olum name="DropdownMenuTrigger" data-o-props='${encodeURIComponent(JSON.stringify({class:a()})).replace(/'/g,`%27`)}'>${n.children}</olum>`,olum.injectStyle(`MenubarTrigger`,c.__style__()),olum.handleMarkup(`MenubarTrigger`,`jvaqjk6ura9`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Po=e=>{let t=e||`MenubarContent`,n=d(t),{align:r=`start`,class:i=``,children:a}=d(t),o=()=>q(`min-w-36`,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`MenubarContent`,`tehu86ac0o`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`MenubarContent`,deps:null,components:{DropdownMenuContent:Ir},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <olum name="DropdownMenuContent" data-o-props='${encodeURIComponent(JSON.stringify({align:n.align===void 0?`start`:n.align,class:o()})).replace(/'/g,`%27`)}'>${n.children}</olum>`,olum.injectStyle(`MenubarContent`,l.__style__()),olum.handleMarkup(`MenubarContent`,`tehu86ac0o`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Fo=e=>{let t=e||`DropdownMenuItem`,n=d(t),{inset:r=!1,variant:i=`default`,disabled:a=!1,onclick:o,class:s=``,children:c}=d(t),l=e=>n.onclick&&n.onclick(e),u=`group/dropdown-menu-item relative flex w-full cursor-default items-center gap-1.5 rounded-md px-1.5 py-1 text-sm outline-none select-none hover:bg-muted disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,f={default:``,destructive:`text-destructive hover:bg-destructive/10 [&_svg]:text-destructive`},p=()=>q(u,f[n.variant===void 0?`default`:n.variant]||f.default,n.inset!==void 0&&n.inset?`pl-7`:``,n.class===void 0?``:n.class);var m=olum.mkElm(`div`,`DropdownMenuItem`,`13gk13rhr85`),h={handleClick:l,classes:p},g={__style__(){return``},methods:{},props:{},compName:`DropdownMenuItem`,deps:null,components:{},get getElm(){var e=m.isConnected?olum.vdom.mkStaging(m):m;return e.innerHTML=`
      <button type="button" data-slot="dropdown-menu-item" data-inset="${olum.esc(n.inset!==void 0&&n.inset)}" data-variant="${olum.esc(n.variant===void 0?`default`:n.variant)}" ${n.disabled!==void 0&&n.disabled?`disabled`:``} class="${olum.esc(p())}" data-o-event='onclick|handleClick=${JSON.stringify([])}'>${n.children}</button>`,olum.injectStyle(`DropdownMenuItem`,g.__style__()),olum.handleMarkup(`DropdownMenuItem`,`13gk13rhr85`,e,h)}};return{methods:g.methods,props:g.props,__OLUM__:g,el:m,methodsRef:h,stateProps:null,localsRef:{get base(){return u},get variants(){return f}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Io=e=>{let t=e||`DropdownMenuSeparator`,n=d(t),{class:r=``}=d(t),i=()=>q(`-mx-1 my-1 h-px bg-border`,n.class===void 0?``:n.class);var a=olum.mkElm(`div`,`DropdownMenuSeparator`,`5n3hvqgbhjb`),o={classes:i},s={__style__(){return``},methods:{},props:{},compName:`DropdownMenuSeparator`,deps:null,components:{},get getElm(){var e=a.isConnected?olum.vdom.mkStaging(a):a;return e.innerHTML=`
      <div data-slot="dropdown-menu-separator" role="separator" class="${olum.esc(i())}"></div>`,olum.injectStyle(`DropdownMenuSeparator`,s.__style__()),olum.handleMarkup(`DropdownMenuSeparator`,`5n3hvqgbhjb`,e,o)}};return{methods:s.methods,props:s.props,__OLUM__:s,el:a,methodsRef:o,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Lo=e=>{let t=e||`DropdownMenuShortcut`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`ml-auto text-xs tracking-widest text-muted-foreground`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`DropdownMenuShortcut`,`swbx2ymv4wa`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`DropdownMenuShortcut`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <span data-slot="dropdown-menu-shortcut" class="${olum.esc(a())}">${n.children}</span>`,olum.injectStyle(`DropdownMenuShortcut`,c.__style__()),olum.handleMarkup(`DropdownMenuShortcut`,`swbx2ymv4wa`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ro=e=>{let t=e||`NavigationMenu`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`group/navigation-menu relative flex max-w-max flex-1 items-center justify-center`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`NavigationMenu`,`ax8iz3okyj`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`NavigationMenu`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <nav data-slot="navigation-menu" class="${olum.esc(a())}">${n.children}</nav>`,olum.injectStyle(`NavigationMenu`,c.__style__()),olum.handleMarkup(`NavigationMenu`,`ax8iz3okyj`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},zo=e=>{let t=e||`NavigationMenuList`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`flex flex-1 list-none items-center justify-center gap-0`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`NavigationMenuList`,`ysrnwpeszw9`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`NavigationMenuList`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="navigation-menu-list" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`NavigationMenuList`,c.__style__()),olum.handleMarkup(`NavigationMenuList`,`ysrnwpeszw9`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Bo=e=>{let t=e||`NavigationMenuItem`,n=d(t),{children:r}=d(t);var i=olum.mkElm(`div`,`NavigationMenuItem`,`uuhesu43drh`),a={},o={__style__(){return``},methods:{},props:{},compName:`NavigationMenuItem`,deps:null,components:{},get getElm(){var e=i.isConnected?olum.vdom.mkStaging(i):i;return e.innerHTML=`
  ...
  <input type="checkbox" class="hidden">
  ${n.children}
</div>`,olum.injectStyle(`NavigationMenuItem`,o.__style__()),olum.handleMarkup(`NavigationMenuItem`,`uuhesu43drh`,e,a)}};return{methods:o.methods,props:o.props,__OLUM__:o,el:i,methodsRef:a,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Vo=e=>{let t=e||`NavigationMenuTrigger`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.closest(`[data-slot="navigation-menu-item"]`),t=e&&e.querySelector(`:scope > input`),n=l.querySelector(`button`),r=()=>{t&&(t.checked=!t.checked,t.dispatchEvent(new Event(`change`,{bubbles:!0})))};return n.addEventListener(`click`,r),()=>n.removeEventListener(`click`,r)});let s=()=>q(`inline-flex h-9 w-max items-center justify-center rounded-lg px-2.5 py-1.5 text-sm font-medium transition-all outline-none select-none hover:bg-muted focus:bg-muted focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 group-has-[>input:checked]/nav-item:bg-muted/50 group-has-[>input:checked]/nav-item:hover:bg-muted`,n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`NavigationMenuTrigger`,`ufgpru9wtsg`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`NavigationMenuTrigger`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
...
</button>`,olum.injectStyle(`NavigationMenuTrigger`,f.__style__()),olum.handleMarkup(`NavigationMenuTrigger`,`ufgpru9wtsg`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ho=e=>{let t=e||`NavigationMenuContent`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.closest(`[data-slot="navigation-menu-item"]`),t=e&&e.querySelector(`:scope > input`),n=()=>{t&&(t.checked=!1,t.dispatchEvent(new Event(`change`,{bubbles:!0})))},r=t=>{e&&!e.contains(t.target)&&n()},i=e=>{e.key===`Escape`&&t&&t.checked&&n()},a=e=>{e.target.closest(`[data-slot=navigation-menu-link]`)&&n()};return document.addEventListener(`click`,r),document.addEventListener(`keydown`,i),l.addEventListener(`click`,a),()=>{document.removeEventListener(`click`,r),document.removeEventListener(`keydown`,i),l.removeEventListener(`click`,a)}});let s=()=>q(`absolute top-full left-0 z-50 mt-2 w-max rounded-lg bg-background p-1 text-foreground shadow ring-1 ring-border outline-none`,n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`NavigationMenuContent`,`gmrx3e80sel`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`NavigationMenuContent`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <div data-slot="navigation-menu-content" class="${olum.esc(s())}">${n.children}</div>`,olum.injectStyle(`NavigationMenuContent`,f.__style__()),olum.handleMarkup(`NavigationMenuContent`,`gmrx3e80sel`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},Uo=e=>{let t=e||`NavigationMenuLink`,n=d(t),{href:r=`#`,variant:i=`default`,class:a=``,children:o}=d(t),s={default:`flex items-center gap-2 rounded-md p-2 text-sm transition-all outline-none hover:bg-muted focus:bg-muted focus-visible:ring-3 focus-visible:ring-ring/50 [&_svg:not([class*='size-'])]:size-4`,trigger:`inline-flex h-9 w-max items-center justify-center rounded-lg px-2.5 py-1.5 text-sm font-medium transition-all outline-none hover:bg-muted focus:bg-muted focus-visible:ring-3 focus-visible:ring-ring/50`},c=()=>q(s[n.variant===void 0?`default`:n.variant]||s.default,n.class===void 0?``:n.class);var l=olum.mkElm(`div`,`NavigationMenuLink`,`oekomynqkj`),u={classes:c},f={__style__(){return``},methods:{},props:{},compName:`NavigationMenuLink`,deps:null,components:{},get getElm(){var e=l.isConnected?olum.vdom.mkStaging(l):l;return e.innerHTML=`
      <a data-slot="navigation-menu-link" href="${olum.esc(n.href===void 0?`#`:n.href)}" class="${olum.esc(c())}">${n.children}</a>`,olum.injectStyle(`NavigationMenuLink`,f.__style__()),olum.handleMarkup(`NavigationMenuLink`,`oekomynqkj`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:l,methodsRef:u,stateProps:null,localsRef:{get variants(){return s}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Wo=e=>{let t=e||`Pagination`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`mx-auto flex w-full justify-center`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`Pagination`,`n678a8fhq8b`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`Pagination`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <nav role="navigation" aria-label="pagination" data-slot="pagination" class="${olum.esc(a())}">${n.children}</nav>`,olum.injectStyle(`Pagination`,c.__style__()),olum.handleMarkup(`Pagination`,`n678a8fhq8b`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Go=e=>{let t=e||`PaginationContent`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`flex items-center gap-0.5`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`PaginationContent`,`2msafqkk761`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`PaginationContent`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <ul data-slot="pagination-content" class="${olum.esc(a())}">${n.children}</ul>`,olum.injectStyle(`PaginationContent`,c.__style__()),olum.handleMarkup(`PaginationContent`,`2msafqkk761`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ko=e=>{let t=e||`PaginationItem`,n=d(t),{children:r}=d(t);var i=olum.mkElm(`div`,`PaginationItem`,`911p0r16ken`),a={},o={__style__(){return``},methods:{},props:{},compName:`PaginationItem`,deps:null,components:{},get getElm(){var e=i.isConnected?olum.vdom.mkStaging(i):i;return e.innerHTML=`
      <li data-slot="pagination-item">${n.children}</li>`,olum.injectStyle(`PaginationItem`,o.__style__()),olum.handleMarkup(`PaginationItem`,`911p0r16ken`,e,a)}};return{methods:o.methods,props:o.props,__OLUM__:o,el:i,methodsRef:a,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},qo=e=>{let t=e||`PaginationLink`,n=d(t),{href:r=`#`,isActive:i=!1,size:a=`icon`,class:o=``,children:s}=d(t),c=`group/button inline-flex shrink-0 items-center justify-center rounded-lg border bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:translate-y-px`,l={active:`border-border bg-background hover:bg-muted hover:text-foreground`,inactive:`border-transparent hover:bg-muted hover:text-foreground`},u={default:`h-8 gap-1.5 px-2.5`,icon:`size-8`},f=()=>q(c,n.isActive!==void 0&&n.isActive?l.active:l.inactive,u[n.size===void 0?`icon`:n.size]||u.icon,n.class===void 0?``:n.class);var p=olum.mkElm(`div`,`PaginationLink`,`ptopx0fw8mi`),m={classes:f},h={__style__(){return``},methods:{},props:{},compName:`PaginationLink`,deps:null,components:{},get getElm(){var e=p.isConnected?olum.vdom.mkStaging(p):p;return e.innerHTML=`
      <a data-slot="pagination-link" data-active="${olum.esc(n.isActive!==void 0&&n.isActive)}" href="${olum.esc(n.href===void 0?`#`:n.href)}" aria-current="${olum.esc(n.isActive!==void 0&&n.isActive?`page`:void 0)}" class="${olum.esc(f())}">${n.children}</a>`,olum.injectStyle(`PaginationLink`,h.__style__()),olum.handleMarkup(`PaginationLink`,`ptopx0fw8mi`,e,m)}};return{methods:h.methods,props:h.props,__OLUM__:h,el:p,methodsRef:m,stateProps:null,localsRef:{get base(){return c},get variants(){return l},get sizes(){return u}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Jo=e=>{let t=e||`PaginationNext`,n=d(t),{href:r=`#`,text:i=`Next`,class:a=``}=d(t),o=()=>q(`gap-1.5 pr-1.5!`,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`PaginationNext`,`luu2mhng5pb`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`PaginationNext`,deps:null,components:{PaginationLink:qo},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"></path></svg>
</olum>`,olum.injectStyle(`PaginationNext`,l.__style__()),olum.handleMarkup(`PaginationNext`,`luu2mhng5pb`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Yo=e=>{let t=e||`PaginationPrevious`,n=d(t),{href:r=`#`,text:i=`Previous`,class:a=``}=d(t),o=()=>q(`gap-1.5 pl-1.5!`,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`PaginationPrevious`,`z6o7ar9w`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`PaginationPrevious`,deps:null,components:{PaginationLink:qo},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
...
</olum>`,olum.injectStyle(`PaginationPrevious`,l.__style__()),olum.handleMarkup(`PaginationPrevious`,`z6o7ar9w`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Xo=e=>{let t=e||`Tabs`,n=d(t),{orientation:r=`horizontal`,class:i=``,children:a}=d(t),o=()=>q(`group/tabs flex gap-2 [&>[data-olum]]:contents`,(n.orientation===void 0?`horizontal`:n.orientation)===`horizontal`?`flex-col`:``,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`Tabs`,`8plar6y6jna`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`Tabs`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <div data-slot="tabs" data-orientation="${olum.esc(n.orientation===void 0?`horizontal`:n.orientation)}" class="${olum.esc(o())}">${n.children}</div>`,olum.injectStyle(`Tabs`,l.__style__()),olum.handleMarkup(`Tabs`,`8plar6y6jna`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Zo=e=>{let t=e||`TabsList`,n=d(t),{variant:r=`default`,class:i=``,children:a}=d(t),o=`group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground h-8`,s={default:`bg-muted`,line:`gap-1 bg-transparent rounded-none`},c=()=>q(o,s[n.variant===void 0?`default`:n.variant]||s.default,n.class===void 0?``:n.class);var l=olum.mkElm(`div`,`TabsList`,`35g4k2u2zyy`),u={classes:c},f={__style__(){return``},methods:{},props:{},compName:`TabsList`,deps:null,components:{},get getElm(){var e=l.isConnected?olum.vdom.mkStaging(l):l;return e.innerHTML=`
      <div data-slot="tabs-list" data-variant="${olum.esc(n.variant===void 0?`default`:n.variant)}" role="tablist" class="${olum.esc(c())}">${n.children}</div>`,olum.injectStyle(`TabsList`,f.__style__()),olum.handleMarkup(`TabsList`,`35g4k2u2zyy`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:l,methodsRef:u,stateProps:null,localsRef:{get base(){return o},get variants(){return s}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Qo=e=>{let t=e||`TabsTrigger`,n=d(t),{value:r,group:i=`tabs`,variant:a=`default`,defaultChecked:o=!1,disabled:s=!1,class:c=``,children:l}=d(t),u=`relative inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center gap-1.5 rounded-md border border-transparent px-1.5 py-0.5 text-sm font-medium whitespace-nowrap text-foreground/60 transition-all cursor-pointer hover:text-foreground has-focus-visible:border-ring has-focus-visible:ring-3 has-focus-visible:ring-ring/50 has-disabled:pointer-events-none has-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,f={default:`has-[:checked]:bg-background has-[:checked]:text-foreground has-[:checked]:shadow-sm`,line:`has-[:checked]:text-foreground after:absolute after:inset-x-0 after:bottom-[-5px] after:h-0.5 after:bg-foreground after:opacity-0 has-[:checked]:after:opacity-100`},p=()=>q(u,f[n.variant===void 0?`default`:n.variant]||f.default,n.class===void 0?``:n.class);var m=olum.mkElm(`div`,`TabsTrigger`,`23fjz2ejs3s`),h={classes:p},g={__style__(){return``},methods:{},props:{},compName:`TabsTrigger`,deps:null,components:{},get getElm(){var e=m.isConnected?olum.vdom.mkStaging(m):m;return e.innerHTML=`
  ...
  ${n.children}
</label>`,olum.injectStyle(`TabsTrigger`,g.__style__()),olum.handleMarkup(`TabsTrigger`,`23fjz2ejs3s`,e,h)}};return{methods:g.methods,props:g.props,__OLUM__:g,el:m,methodsRef:h,stateProps:null,localsRef:{get base(){return u},get variants(){return f}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},$o=e=>{let t=e||`TabsContent`,n=d(t),{value:r,class:i=``,children:a}=d(t);var s={active:!1},c=o(()=>{let e=f.closest(`[data-slot="tabs"]`),t=()=>{let t=e&&e.querySelector(`input[type=radio]:checked`);s.active=!!t&&t.value===n.value};return t(),e&&e.addEventListener(`change`,t),()=>e&&e.removeEventListener(`change`,t)});let l=()=>q(`flex-1 text-sm outline-none`,n.class===void 0?``:n.class);var u=olum.mkElm(`div`,`TabsContent`,`j9favytka4`),f=u,p={classes:l},m={__style__(){return``},methods:{},props:{},compName:`TabsContent`,deps:null,components:{},get getElm(){var e=u.isConnected?olum.vdom.mkStaging(u):u;return e.innerHTML=`
      <div data-o-show="" style="display:${s.active?`contents`:`none`};">
  <div data-slot="tabs-content" class="${olum.esc(l())}">${n.children}</div>
</div>`,olum.injectStyle(`TabsContent`,m.__style__()),olum.handleMarkup(`TabsContent`,`j9favytka4`,e,p)}};return s.__olum__={compName:t,compId:`j9favytka4`},s=olum.proxyHandler(s,null,u),{methods:m.methods,props:m.props,__OLUM__:m,el:u,methodsRef:p,stateProps:s,localsRef:{},hooks:{mounted:c===void 0?null:c,unMounted:null,isMounted:!1,isUnMounted:!1}}},es=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><rect width="16" height="20" x="4" y="2" rx="2"/><path d="M8 6h8m0 8v4m0-8h.01M12 10h.01M8 10h.01M12 14h.01M8 14h.01M12 18h.01M8 18h.01"/></svg>`,ts=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M16 2v2M7 21v-2a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v2M8 2v2"/><circle cx="12" cy="10" r="3"/><rect width="18" height="18" x="3" y="3" rx="2"/></svg>`,ns=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M8 2v3m8-3v3"/><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/></svg>`,rs=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>`,is=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><rect width="20" height="14" x="2" y="5" rx="2"/><path d="M2 10h20"/></svg>`,as=e=>{let t=e||`page`;var n={page:1};let r=Array.from({length:5},(e,t)=>t+1),i=e=>{let t=e.target.closest(`[data-slot="pagination-link"], [aria-label="Go to next page"], [aria-label="Go to previous page"]`);if(!t)return;e.preventDefault();let r=t.getAttribute(`aria-label`)||``;if(r===`Go to next page`)n.page=Math.min(5,n.page+1);else if(r===`Go to previous page`)n.page=Math.max(1,n.page-1);else{let e=parseInt(t.textContent.trim(),10);Number.isNaN(e)||(n.page=e)}},a=()=>console.log(`File > New file`),o=()=>console.log(`File > Save`);var s=olum.mkElm(`div`,`page`,`zos1kjiee1`),c={onPageClick:i,fileAction:a,saveAction:o},l={__style__(){return``},methods:{},props:{},compName:`page`,deps:null,components:{Nav:X,FeatureSidebar:Z,SiteFooter:Q,Icon:Y,Button:J,Breadcrumb:io,BreadcrumbList:ao,BreadcrumbItem:oo,BreadcrumbLink:so,BreadcrumbPage:co,BreadcrumbSeparator:lo,BreadcrumbEllipsis:uo,Command:fo,CommandInput:po,CommandList:mo,CommandEmpty:ho,CommandGroup:go,CommandItem:_o,CommandSeparator:vo,CommandShortcut:yo,CommandDialog:bo,CommandDialogTrigger:xo,CommandDialogContent:Ao,Menubar:jo,MenubarMenu:Mo,MenubarTrigger:No,MenubarContent:Po,DropdownMenuItem:Fo,DropdownMenuSeparator:Io,DropdownMenuShortcut:Lo,NavigationMenu:Ro,NavigationMenuList:zo,NavigationMenuItem:Bo,NavigationMenuTrigger:Vo,NavigationMenuContent:Ho,NavigationMenuLink:Uo,Pagination:Wo,PaginationContent:Go,PaginationItem:Ko,PaginationLink:qo,PaginationNext:Jo,PaginationPrevious:Yo,Tabs:Xo,TabsList:Zo,TabsTrigger:Qo,TabsContent:$o,Anchor:Ye},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <olum name="Nav"></olum>
        ...
        <olum name="Command">
          ...
          <olum name="CommandList">
            ...
            <olum name="CommandGroup" data-o-props='${encodeURIComponent(JSON.stringify({heading:`Suggestions`})).replace(/'/g,`%27`)}'>
              <olum name="CommandItem"><olum name="Icon" data-o-props='${encodeURIComponent(JSON.stringify({icon:ns,class:`size-4`})).replace(/'/g,`%27`)}'></olum><span>Calendar</span></olum>
              <olum name="CommandItem"><olum name="Icon" data-o-props='${encodeURIComponent(JSON.stringify({icon:ts,class:`size-4`})).replace(/'/g,`%27`)}'></olum><span>Search emoji</span></olum>
              <olum name="CommandItem"><olum name="Icon" data-o-props='${encodeURIComponent(JSON.stringify({icon:es,class:`size-4`})).replace(/'/g,`%27`)}'></olum><span>Calculator</span></olum>
            </olum>
            ...
            <olum name="CommandGroup" data-o-props='${encodeURIComponent(JSON.stringify({heading:`Settings`})).replace(/'/g,`%27`)}'>
              <olum name="CommandItem"><olum name="Icon" data-o-props='${encodeURIComponent(JSON.stringify({icon:rs,class:`size-4`})).replace(/'/g,`%27`)}'></olum><span>Profile</span><olum name="CommandShortcut">⌘P</olum></olum>
              <olum name="CommandItem"><olum name="Icon" data-o-props='${encodeURIComponent(JSON.stringify({icon:is,class:`size-4`})).replace(/'/g,`%27`)}'></olum><span>Billing</span><olum name="CommandShortcut">⌘B</olum></olum>
              <olum name="CommandItem"><olum name="Icon" data-o-props='${encodeURIComponent(JSON.stringify({icon:to,class:`size-4`})).replace(/'/g,`%27`)}'></olum><span>Settings</span><olum name="CommandShortcut">⌘S</olum></olum>
            </olum>
          </olum>
        </olum>
      </div>
...
<olum name="SiteFooter"></olum>`,olum.injectStyle(`page`,l.__style__()),olum.handleMarkup(`page`,`zos1kjiee1`,e,c)}};return n.__olum__={compName:t,compId:`zos1kjiee1`},n=olum.proxyHandler(n,null,s),{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:n,localsRef:{get totalPages(){return 5}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},os=e=>{let t=e||`AlertDialog`,n=d(t),{defaultOpen:r=!1,children:i}=d(t);var a=olum.mkElm(`div`,`AlertDialog`,`ir1jmk1h07l`),o={},s={__style__(){return``},methods:{},props:{},compName:`AlertDialog`,deps:null,components:{},get getElm(){var e=a.isConnected?olum.vdom.mkStaging(a):a;return e.innerHTML=`
      <div data-slot="alert-dialog" class="contents">
  <input type="checkbox" class="hidden" ${n.defaultOpen!==void 0&&n.defaultOpen?`checked`:``}>
  ${n.children}
</div>`,olum.injectStyle(`AlertDialog`,s.__style__()),olum.handleMarkup(`AlertDialog`,`ir1jmk1h07l`,e,o)}};return{methods:s.methods,props:s.props,__OLUM__:s,el:a,methodsRef:o,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ss=e=>{let t=e||`AlertDialogTrigger`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.closest(`[data-slot="alert-dialog"]`),t=e&&e.querySelector(`:scope > input`),n=l.querySelector(`button`),r=()=>{t&&(t.checked=!0,t.dispatchEvent(new Event(`change`,{bubbles:!0})))};return n.addEventListener(`click`,r),()=>n.removeEventListener(`click`,r)});let s=()=>q(n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`AlertDialogTrigger`,`bs6tgpbdjw9`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`AlertDialogTrigger`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <button type="button" data-slot="alert-dialog-trigger" class="${olum.esc(s())}">${n.children}</button>`,olum.injectStyle(`AlertDialogTrigger`,f.__style__()),olum.handleMarkup(`AlertDialogTrigger`,`bs6tgpbdjw9`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},cs=e=>{let t=e||`AlertDialogContent`,n=d(t),{size:r=`default`,class:i=``,children:a}=d(t);var s=o(()=>{let e=u.closest(`[data-slot="alert-dialog"]`),t=e&&e.querySelector(`:scope > input`),n=u.querySelector(`[data-slot="alert-dialog-overlay"]`),r=u.querySelector(`[data-slot="alert-dialog-content"]`);if(!(!t||!n||!r))return r.__olumModalInput=t,ko({input:t,nodes:[n,r],displays:[`block`,`grid`]})});let c=()=>q(`group/alert-dialog-content top-1/2 left-1/2 z-50 w-full -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl bg-background p-4 text-popover-foreground ring-1 ring-border outline-none data-[size=default]:max-w-xs data-[size=sm]:max-w-xs data-[size=default]:sm:max-w-sm fixed`,n.class===void 0?``:n.class);var l=olum.mkElm(`div`,`AlertDialogContent`,`uv56iefwe6g`),u=l,f={classes:c},p={__style__(){return``},methods:{},props:{},compName:`AlertDialogContent`,deps:null,components:{},get getElm(){var e=l.isConnected?olum.vdom.mkStaging(l):l;return e.innerHTML=`
      <div data-slot="alert-dialog-overlay" style="display: none" class="fixed inset-0 z-50 bg-black/20"></div>
<div data-slot="alert-dialog-content" data-size="${olum.esc(n.size===void 0?`default`:n.size)}" style="display: none" class="${olum.esc(c())}">${n.children}</div>`,olum.injectStyle(`AlertDialogContent`,p.__style__()),olum.handleMarkup(`AlertDialogContent`,`uv56iefwe6g`,e,f)}};return{methods:p.methods,props:p.props,__OLUM__:p,el:l,methodsRef:f,stateProps:null,localsRef:{},hooks:{mounted:s===void 0?null:s,unMounted:null,isMounted:!1,isUnMounted:!1}}},ls=e=>{let t=e||`AlertDialogHeader`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`group/alert-dialog-header grid grid-rows-[auto_1fr] place-items-center gap-1.5 text-center [&>[data-olum]]:contents has-data-[slot=alert-dialog-media]:place-items-start has-data-[slot=alert-dialog-media]:gap-x-4 has-data-[slot=alert-dialog-media]:text-left`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`AlertDialogHeader`,`tgaw4y3yrwn`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`AlertDialogHeader`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="alert-dialog-header" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`AlertDialogHeader`,c.__style__()),olum.handleMarkup(`AlertDialogHeader`,`tgaw4y3yrwn`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},us=e=>{let t=e||`AlertDialogTitle`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`font-heading text-base font-medium group-has-data-[slot=alert-dialog-media]/alert-dialog-header:col-start-2`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`AlertDialogTitle`,`s45x80ty87`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`AlertDialogTitle`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="alert-dialog-title" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`AlertDialogTitle`,c.__style__()),olum.handleMarkup(`AlertDialogTitle`,`s45x80ty87`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ds=e=>{let t=e||`AlertDialogDescription`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`text-sm text-balance text-muted-foreground [&_a]:underline [&_a]:underline-offset-3 [&_a]:hover:text-foreground`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`AlertDialogDescription`,`34l249rn0io`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`AlertDialogDescription`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="alert-dialog-description" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`AlertDialogDescription`,c.__style__()),olum.handleMarkup(`AlertDialogDescription`,`34l249rn0io`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},fs=e=>{let t=e||`AlertDialogFooter`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`-mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl border-t bg-muted/50 p-4 [&>[data-olum]]:contents group-data-[size=sm]/alert-dialog-content:grid group-data-[size=sm]/alert-dialog-content:grid-cols-2 sm:flex-row sm:justify-end`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`AlertDialogFooter`,`ldhwgt44guk`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`AlertDialogFooter`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="alert-dialog-footer" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`AlertDialogFooter`,c.__style__()),olum.handleMarkup(`AlertDialogFooter`,`ldhwgt44guk`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ps=e=>{let t=e||`AlertDialogCancel`,n=d(t),{variant:r=`outline`,size:i=`default`,class:a=``,children:s}=d(t);var c=o(()=>{let e=f.querySelector(`button`),t=()=>{let e=Oo(f,`alert-dialog`,`alert-dialog-content`);e&&(e.checked=!1,e.dispatchEvent(new Event(`change`,{bubbles:!0})))};return e.addEventListener(`click`,t),()=>e.removeEventListener(`click`,t)});let l=()=>q(`group-data-[size=sm]/alert-dialog-content:w-full`,n.class===void 0?``:n.class);var u=olum.mkElm(`div`,`AlertDialogCancel`,`1v337q7h6d8`),f=u,p={classes:l},m={__style__(){return``},methods:{},props:{},compName:`AlertDialogCancel`,deps:null,components:{Button:J},get getElm(){var e=u.isConnected?olum.vdom.mkStaging(u):u;return e.innerHTML=`
      <olum name="Button" data-o-props='${encodeURIComponent(JSON.stringify({variant:n.variant===void 0?`outline`:n.variant,size:n.size===void 0?`default`:n.size,class:l()})).replace(/'/g,`%27`)}'>${n.children}</olum>`,olum.injectStyle(`AlertDialogCancel`,m.__style__()),olum.handleMarkup(`AlertDialogCancel`,`1v337q7h6d8`,e,p)}};return{methods:m.methods,props:m.props,__OLUM__:m,el:u,methodsRef:p,stateProps:null,localsRef:{},hooks:{mounted:c===void 0?null:c,unMounted:null,isMounted:!1,isUnMounted:!1}}},ms=e=>{let t=e||`AlertDialogAction`,n=d(t),{class:r=``,onclick:i,children:a}=d(t);var s=o(()=>{let e=u.querySelector(`button`),t=()=>{n.onclick&&n.onclick();let e=Oo(u,`alert-dialog`,`alert-dialog-content`);e&&(e.checked=!1,e.dispatchEvent(new Event(`change`,{bubbles:!0})))};return e.addEventListener(`click`,t),()=>e.removeEventListener(`click`,t)});let c=()=>q(`group-data-[size=sm]/alert-dialog-content:w-full`,n.class===void 0?``:n.class);var l=olum.mkElm(`div`,`AlertDialogAction`,`ar21odvyl4a`),u=l,f={classes:c},p={__style__(){return``},methods:{},props:{},compName:`AlertDialogAction`,deps:null,components:{Button:J},get getElm(){var e=l.isConnected?olum.vdom.mkStaging(l):l;return e.innerHTML=`
      <olum name="Button" data-o-props='${encodeURIComponent(JSON.stringify({slot:`alert-dialog-action`,class:c()})).replace(/'/g,`%27`)}'>${n.children}</olum>`,olum.injectStyle(`AlertDialogAction`,p.__style__()),olum.handleMarkup(`AlertDialogAction`,`ar21odvyl4a`,e,f)}};return{methods:p.methods,props:p.props,__OLUM__:p,el:l,methodsRef:f,stateProps:null,localsRef:{},hooks:{mounted:s===void 0?null:s,unMounted:null,isMounted:!1,isUnMounted:!1}}},hs=e=>{let t=e||`ContextMenu`,n=d(t),{children:r}=d(t);var i=olum.mkElm(`div`,`ContextMenu`,`moururl21qs`),a={},o={__style__(){return``},methods:{},props:{},compName:`ContextMenu`,deps:null,components:{},get getElm(){var e=i.isConnected?olum.vdom.mkStaging(i):i;return e.innerHTML=`
  ...
  <input type="checkbox" class="hidden">
  ${n.children}
</div>`,olum.injectStyle(`ContextMenu`,o.__style__()),olum.handleMarkup(`ContextMenu`,`moururl21qs`,e,a)}};return{methods:o.methods,props:o.props,__OLUM__:o,el:i,methodsRef:a,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},gs=e=>{let t=e||`ContextMenuTrigger`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.closest(`[data-slot="context-menu"]`),t=e&&e.querySelector(`:scope > input`),n=e&&e.querySelector(`[data-slot="context-menu-content"]`),r=l.firstElementChild,i=e=>{if(e.preventDefault(),t){if(n){let t=r.getBoundingClientRect();n.style.left=e.clientX-t.left+`px`,n.style.top=e.clientY-t.top+`px`}t.checked=!0,t.dispatchEvent(new Event(`change`,{bubbles:!0}))}};return r.addEventListener(`contextmenu`,i),()=>r.removeEventListener(`contextmenu`,i)});let s=()=>q(`select-none`,n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`ContextMenuTrigger`,`a76521gvbrm`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`ContextMenuTrigger`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <div data-slot="context-menu-trigger" class="${olum.esc(s())}">${n.children}</div>`,olum.injectStyle(`ContextMenuTrigger`,f.__style__()),olum.handleMarkup(`ContextMenuTrigger`,`a76521gvbrm`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},_s=e=>{let t=e||`ContextMenuContent`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.closest(`[data-slot="context-menu"]`),t=e&&e.querySelector(`:scope > input`),n=()=>{t&&(t.checked=!1,t.dispatchEvent(new Event(`change`,{bubbles:!0})))},r=e=>{let t=l.querySelector(`[data-slot="context-menu-content"]`);t&&!t.contains(e.target)&&n()},i=e=>{e.key===`Escape`&&t&&t.checked&&n()},a=e=>{e.target.closest(`[data-slot=dropdown-menu-item]`)&&n()};return document.addEventListener(`click`,r),document.addEventListener(`keydown`,i),l.addEventListener(`click`,a),()=>{document.removeEventListener(`click`,r),document.removeEventListener(`keydown`,i),l.removeEventListener(`click`,a)}});let s=()=>q(`absolute z-50 min-w-36 rounded-lg bg-background p-1 text-foreground shadow-md ring-1 ring-border outline-none`,n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`ContextMenuContent`,`3f28b6bfsgj`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`ContextMenuContent`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <div data-slot="context-menu-content" class="${olum.esc(s())}">${n.children}</div>`,olum.injectStyle(`ContextMenuContent`,f.__style__()),olum.handleMarkup(`ContextMenuContent`,`3f28b6bfsgj`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},vs=e=>{let t=e||`Dialog`,n=d(t),{defaultOpen:r=!1,children:i}=d(t);var a=olum.mkElm(`div`,`Dialog`,`o9jqelmhew9`),o={},s={__style__(){return``},methods:{},props:{},compName:`Dialog`,deps:null,components:{},get getElm(){var e=a.isConnected?olum.vdom.mkStaging(a):a;return e.innerHTML=`
      <div data-slot="dialog" class="contents">
  <input type="checkbox" class="hidden" ${n.defaultOpen!==void 0&&n.defaultOpen?`checked`:``}>
  ${n.children}
</div>`,olum.injectStyle(`Dialog`,s.__style__()),olum.handleMarkup(`Dialog`,`o9jqelmhew9`,e,o)}};return{methods:s.methods,props:s.props,__OLUM__:s,el:a,methodsRef:o,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ys=e=>{let t=e||`DialogTrigger`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.closest(`[data-slot="dialog"]`),t=e&&e.querySelector(`:scope > input`),n=l.querySelector(`button`),r=()=>{t&&(t.checked=!0,t.dispatchEvent(new Event(`change`,{bubbles:!0})))};return n.addEventListener(`click`,r),()=>n.removeEventListener(`click`,r)});let s=()=>q(n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`DialogTrigger`,`7et8xekglu5`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`DialogTrigger`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <button type="button" data-slot="dialog-trigger" class="${olum.esc(s())}">${n.children}</button>`,olum.injectStyle(`DialogTrigger`,f.__style__()),olum.handleMarkup(`DialogTrigger`,`7et8xekglu5`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},bs=e=>{let t=e||`DialogContent`,n=d(t),{showCloseButton:r=!0,class:i=``,children:a}=d(t);var s=o(()=>{let e=u.closest(`[data-slot="dialog"]`),t=e&&e.querySelector(`:scope > input`),n=u.querySelector(`[data-slot="dialog-overlay"]`),r=u.querySelector(`[data-slot="dialog-content"]`),i=u.querySelector(`[data-builtin-close]`);if(!t||!n||!r)return;r.__olumModalInput=t;let a=()=>{t.checked=!1,t.dispatchEvent(new Event(`change`,{bubbles:!0}))},o=e=>{e.key===`Escape`&&t.checked&&a()},s=e=>{e.target===n&&a()};i&&i.addEventListener(`click`,a),n.addEventListener(`click`,s),document.addEventListener(`keydown`,o);let c=ko({input:t,nodes:[n,r],displays:[`block`,`grid`]});return()=>{i&&i.removeEventListener(`click`,a),n.removeEventListener(`click`,s),document.removeEventListener(`keydown`,o),c()}});let c=()=>q(`top-1/2 left-1/2 z-50 w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl bg-background p-4 text-sm text-foreground ring-1 ring-border outline-none sm:max-w-sm fixed`,n.class===void 0?``:n.class);var l=olum.mkElm(`div`,`DialogContent`,`30dgu2mnzdu`),u=l,f={classes:c},p={__style__(){return``},methods:{},props:{},compName:`DialogContent`,deps:null,components:{},get getElm(){var e=l.isConnected?olum.vdom.mkStaging(l):l;return e.innerHTML=`
...
<div data-slot="dialog-content" style="display: none" class="${olum.esc(c())}">
  ...
  `:``}
</div>`,olum.injectStyle(`DialogContent`,p.__style__()),olum.handleMarkup(`DialogContent`,`30dgu2mnzdu`,e,f)}};return{methods:p.methods,props:p.props,__OLUM__:p,el:l,methodsRef:f,stateProps:null,localsRef:{},hooks:{mounted:s===void 0?null:s,unMounted:null,isMounted:!1,isUnMounted:!1}}},xs=e=>{let t=e||`DialogHeader`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`flex flex-col gap-2`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`DialogHeader`,`3u22558n67x`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`DialogHeader`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="dialog-header" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`DialogHeader`,c.__style__()),olum.handleMarkup(`DialogHeader`,`3u22558n67x`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ss=e=>{let t=e||`DialogTitle`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`font-heading text-base leading-none font-medium`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`DialogTitle`,`pjnn4ok9mmn`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`DialogTitle`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="dialog-title" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`DialogTitle`,c.__style__()),olum.handleMarkup(`DialogTitle`,`pjnn4ok9mmn`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Cs=e=>{let t=e||`DialogDescription`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`text-sm text-muted-foreground [&_a]:underline [&_a]:underline-offset-3 [&_a]:hover:text-foreground`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`DialogDescription`,`7f3vji4k09b`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`DialogDescription`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="dialog-description" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`DialogDescription`,c.__style__()),olum.handleMarkup(`DialogDescription`,`7f3vji4k09b`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ws=e=>{let t=e||`DialogFooter`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`-mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl border-t bg-muted/50 p-4 sm:flex-row sm:justify-end`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`DialogFooter`,`lw8u59grqq`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`DialogFooter`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="dialog-footer" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`DialogFooter`,c.__style__()),olum.handleMarkup(`DialogFooter`,`lw8u59grqq`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ts=e=>{let t=e||`DialogClose`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.querySelector(`button`),t=()=>{let e=Oo(l,`dialog`,`dialog-content`);e&&(e.checked=!1,e.dispatchEvent(new Event(`change`,{bubbles:!0})))};return e.addEventListener(`click`,t),()=>e.removeEventListener(`click`,t)});let s=()=>q(n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`DialogClose`,`msq2bqy3jq`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`DialogClose`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <button type="button" data-slot="dialog-close" class="${olum.esc(s())}">${n.children}</button>`,olum.injectStyle(`DialogClose`,f.__style__()),olum.handleMarkup(`DialogClose`,`msq2bqy3jq`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},Es=e=>{let t=e||`Drawer`,n=d(t),{children:r}=d(t);var i=olum.mkElm(`div`,`Drawer`,`sfs98x5aql`),a={},o={__style__(){return``},methods:{},props:{},compName:`Drawer`,deps:null,components:{},get getElm(){var e=i.isConnected?olum.vdom.mkStaging(i):i;return e.innerHTML=`
      <div data-slot="drawer" class="contents">
  <input type="checkbox" class="hidden">
  ${n.children}
</div>`,olum.injectStyle(`Drawer`,o.__style__()),olum.handleMarkup(`Drawer`,`sfs98x5aql`,e,a)}};return{methods:o.methods,props:o.props,__OLUM__:o,el:i,methodsRef:a,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ds=e=>{let t=e||`DrawerTrigger`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.closest(`[data-slot="drawer"]`),t=e&&e.querySelector(`:scope > input`),n=l.querySelector(`button`),r=()=>{t&&(t.checked=!0,t.dispatchEvent(new Event(`change`,{bubbles:!0})))};return n.addEventListener(`click`,r),()=>n.removeEventListener(`click`,r)});let s=()=>q(n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`DrawerTrigger`,`23wmrvv7u17`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`DrawerTrigger`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <button type="button" data-slot="drawer-trigger" class="${olum.esc(s())}">${n.children}</button>`,olum.injectStyle(`DrawerTrigger`,f.__style__()),olum.handleMarkup(`DrawerTrigger`,`23wmrvv7u17`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},Os=e=>{let t=e||`DrawerContent`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.closest(`[data-slot="drawer"]`),t=e&&e.querySelector(`:scope > input`),n=l.querySelector(`[data-slot="drawer-overlay"]`),r=l.querySelector(`[data-slot="drawer-content"]`);if(!t||!n||!r)return;r.__olumModalInput=t;let i=()=>{t.checked=!1,t.dispatchEvent(new Event(`change`,{bubbles:!0}))},a=e=>{e.key===`Escape`&&t.checked&&i()},o=e=>{e.target===n&&i()};n.addEventListener(`click`,o),document.addEventListener(`keydown`,a);let s=ko({input:t,nodes:[n,r],displays:[`block`,`flex`]});return()=>{n.removeEventListener(`click`,o),document.removeEventListener(`keydown`,a),s()}});let s=()=>q(`group/drawer-popup fixed inset-x-0 bottom-0 z-50 flex h-auto max-h-[80vh] flex-col rounded-t-xl border-t bg-background text-sm text-foreground`,n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`DrawerContent`,`zq23tbuy8u`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`DrawerContent`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
...
<div data-slot="drawer-content" style="display: none" class="${olum.esc(s())}">
  ...
  ${n.children}
</div>`,olum.injectStyle(`DrawerContent`,f.__style__()),olum.handleMarkup(`DrawerContent`,`zq23tbuy8u`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},ks=e=>{let t=e||`DrawerHeader`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`flex shrink-0 flex-col gap-0.5 p-4 pb-0 text-center`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`DrawerHeader`,`q1gtjregn6a`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`DrawerHeader`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="drawer-header" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`DrawerHeader`,c.__style__()),olum.handleMarkup(`DrawerHeader`,`q1gtjregn6a`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},As=e=>{let t=e||`DrawerTitle`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`font-heading text-base font-medium text-foreground`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`DrawerTitle`,`oimbxpgsh29`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`DrawerTitle`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="drawer-title" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`DrawerTitle`,c.__style__()),olum.handleMarkup(`DrawerTitle`,`oimbxpgsh29`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},js=e=>{let t=e||`DrawerDescription`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`text-sm text-balance text-muted-foreground`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`DrawerDescription`,`dzmhz6fw0tw`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`DrawerDescription`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="drawer-description" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`DrawerDescription`,c.__style__()),olum.handleMarkup(`DrawerDescription`,`dzmhz6fw0tw`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ms=e=>{let t=e||`DrawerFooter`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`mt-auto flex shrink-0 flex-col gap-2 p-4 pt-0`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`DrawerFooter`,`zd9kg646cjk`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`DrawerFooter`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="drawer-footer" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`DrawerFooter`,c.__style__()),olum.handleMarkup(`DrawerFooter`,`zd9kg646cjk`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ns=e=>{let t=e||`DrawerClose`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.querySelector(`button`),t=()=>{let e=Oo(l,`drawer`,`drawer-content`);e&&(e.checked=!1,e.dispatchEvent(new Event(`change`,{bubbles:!0})))};return e.addEventListener(`click`,t),()=>e.removeEventListener(`click`,t)});let s=()=>q(n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`DrawerClose`,`k5gniuuvkni`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`DrawerClose`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <button type="button" data-slot="drawer-close" class="${olum.esc(s())}">${n.children}</button>`,olum.injectStyle(`DrawerClose`,f.__style__()),olum.handleMarkup(`DrawerClose`,`k5gniuuvkni`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ps=e=>{let t=e||`DropdownMenuLabel`,n=d(t),{inset:r=!1,class:i=``,children:a}=d(t),o=()=>q(`px-1.5 py-1 text-xs font-medium text-muted-foreground`,n.inset!==void 0&&n.inset?`pl-7`:``,n.class===void 0?``:n.class);var s=olum.mkElm(`div`,`DropdownMenuLabel`,`x2b2b90s2uh`),c={classes:o},l={__style__(){return``},methods:{},props:{},compName:`DropdownMenuLabel`,deps:null,components:{},get getElm(){var e=s.isConnected?olum.vdom.mkStaging(s):s;return e.innerHTML=`
      <div data-slot="dropdown-menu-label" data-inset="${olum.esc(n.inset!==void 0&&n.inset)}" class="${olum.esc(o())}">${n.children}</div>`,olum.injectStyle(`DropdownMenuLabel`,l.__style__()),olum.handleMarkup(`DropdownMenuLabel`,`x2b2b90s2uh`,e,c)}};return{methods:l.methods,props:l.props,__OLUM__:l,el:s,methodsRef:c,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Fs=e=>{let t=e||`DropdownMenuGroup`,n=d(t),{children:r}=d(t);var i=olum.mkElm(`div`,`DropdownMenuGroup`,`w5eg29qr21g`),a={},o={__style__(){return``},methods:{},props:{},compName:`DropdownMenuGroup`,deps:null,components:{},get getElm(){var e=i.isConnected?olum.vdom.mkStaging(i):i;return e.innerHTML=`
      <div data-slot="dropdown-menu-group" role="group">${n.children}</div>`,olum.injectStyle(`DropdownMenuGroup`,o.__style__()),olum.handleMarkup(`DropdownMenuGroup`,`w5eg29qr21g`,e,a)}};return{methods:o.methods,props:o.props,__OLUM__:o,el:i,methodsRef:a,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Is=e=>{let t=e||`DropdownMenuRadioGroup`,n=d(t),{children:r}=d(t);var i=olum.mkElm(`div`,`DropdownMenuRadioGroup`,`s1golfqzvcl`),a={},o={__style__(){return``},methods:{},props:{},compName:`DropdownMenuRadioGroup`,deps:null,components:{},get getElm(){var e=i.isConnected?olum.vdom.mkStaging(i):i;return e.innerHTML=`
      <div data-slot="dropdown-menu-radio-group" role="radiogroup">${n.children}</div>`,olum.injectStyle(`DropdownMenuRadioGroup`,o.__style__()),olum.handleMarkup(`DropdownMenuRadioGroup`,`s1golfqzvcl`,e,a)}};return{methods:o.methods,props:o.props,__OLUM__:o,el:i,methodsRef:a,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ls=e=>{let t=e||`DropdownMenuRadioItem`,n=d(t),{name:r=`dropdown-radio`,value:i,defaultChecked:a=!1,inset:o=!1,disabled:s=!1,onCheckedChange:c,class:l=``,children:u}=d(t),f=()=>n.onCheckedChange&&n.onCheckedChange(n.value),p=`relative flex w-full cursor-default items-center gap-1.5 rounded-md py-1 pr-8 pl-1.5 text-sm outline-none select-none hover:bg-muted has-checked:bg-muted disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,m=()=>q(p,n.inset!==void 0&&n.inset?`pl-7`:``,n.class===void 0?``:n.class);var h=olum.mkElm(`div`,`DropdownMenuRadioItem`,`w48eutb59y`),g={handleChange:f,classes:m},_={__style__(){return``},methods:{},props:{},compName:`DropdownMenuRadioItem`,deps:null,components:{},get getElm(){var e=h.isConnected?olum.vdom.mkStaging(h):h;return e.innerHTML=`
  ...
  ${n.children}
</label>`,olum.injectStyle(`DropdownMenuRadioItem`,_.__style__()),olum.handleMarkup(`DropdownMenuRadioItem`,`w48eutb59y`,e,g)}};return{methods:_.methods,props:_.props,__OLUM__:_,el:h,methodsRef:g,stateProps:null,localsRef:{get base(){return p}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Rs=e=>{let t=e||`DropdownMenuSub`,n=d(t),{children:r}=d(t);var i=olum.mkElm(`div`,`DropdownMenuSub`,`hzd8zw2pyn9`),a={},o={__style__(){return``},methods:{},props:{},compName:`DropdownMenuSub`,deps:null,components:{},get getElm(){var e=i.isConnected?olum.vdom.mkStaging(i):i;return e.innerHTML=`
  ...
  <input type="checkbox" class="hidden">
  ${n.children}
</div>`,olum.injectStyle(`DropdownMenuSub`,o.__style__()),olum.handleMarkup(`DropdownMenuSub`,`hzd8zw2pyn9`,e,a)}};return{methods:o.methods,props:o.props,__OLUM__:o,el:i,methodsRef:a,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},zs=e=>{let t=e||`DropdownMenuSubTrigger`,n=d(t),{inset:r=!1,class:i=``,children:a}=d(t);var s=o(()=>{let e=f.closest(`[data-slot="dropdown-menu-sub"]`),t=e&&e.querySelector(`:scope > input`),n=f.querySelector(`button`),r=e=>{t&&(t.checked=e,t.dispatchEvent(new Event(`change`,{bubbles:!0})))},i=()=>r(!0),a=()=>r(!1);return n.addEventListener(`mouseenter`,i),n.addEventListener(`mouseleave`,a),()=>{n.removeEventListener(`mouseenter`,i),n.removeEventListener(`mouseleave`,a)}});let c=`flex w-full cursor-default items-center gap-1.5 rounded-md px-1.5 py-1 text-sm outline-none select-none hover:bg-muted [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,l=()=>q(c,n.inset!==void 0&&n.inset?`pl-7`:``,n.class===void 0?``:n.class);var u=olum.mkElm(`div`,`DropdownMenuSubTrigger`,`j58gwhts1m8`),f=u,p={classes:l},m={__style__(){return``},methods:{},props:{},compName:`DropdownMenuSubTrigger`,deps:null,components:{},get getElm(){var e=u.isConnected?olum.vdom.mkStaging(u):u;return e.innerHTML=`
  ...
  <input type="checkbox" class="hidden">
  ${n.children}
</div>`,olum.injectStyle(`HoverCard`,o.__style__()),olum.handleMarkup(`HoverCard`,`ywj25bm3p3j`,e,a)}};return{methods:o.methods,props:o.props,__OLUM__:o,el:i,methodsRef:a,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Hs=e=>{let t=e||`HoverCardTrigger`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.closest(`[data-slot="hover-card"]`),t=e&&e.querySelector(`:scope > input`),n=l.firstElementChild,r=e=>{t&&(t.checked=e,t.dispatchEvent(new Event(`change`,{bubbles:!0})))},i=()=>r(!0),a=()=>r(!1);return n.addEventListener(`mouseenter`,i),n.addEventListener(`mouseleave`,a),()=>{n.removeEventListener(`mouseenter`,i),n.removeEventListener(`mouseleave`,a)}});let s=()=>q(n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`HoverCardTrigger`,`39wfcdnvwld`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`HoverCardTrigger`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <span data-slot="hover-card-trigger" class="${olum.esc(s())}">${n.children}</span>`,olum.injectStyle(`HoverCardTrigger`,f.__style__()),olum.handleMarkup(`HoverCardTrigger`,`39wfcdnvwld`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},Us=e=>{let t=e||`HoverCardContent`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`absolute top-full left-1/2 z-50 mt-1 w-64 -translate-x-1/2 rounded-lg bg-background p-2.5 text-sm text-foreground shadow-md ring-1 ring-border outline-none`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`HoverCardContent`,`wrt5l4nhuf`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`HoverCardContent`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="hover-card-content" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`HoverCardContent`,c.__style__()),olum.handleMarkup(`HoverCardContent`,`wrt5l4nhuf`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ws=e=>{let t=e||`Popover`,n=d(t),{children:r}=d(t);var i=olum.mkElm(`div`,`Popover`,`ewr06wl8h1i`),a={},o={__style__(){return``},methods:{},props:{},compName:`Popover`,deps:null,components:{},get getElm(){var e=i.isConnected?olum.vdom.mkStaging(i):i;return e.innerHTML=`
  ...
  <input type="checkbox" class="hidden">
  ${n.children}
</div>`,olum.injectStyle(`Popover`,o.__style__()),olum.handleMarkup(`Popover`,`ewr06wl8h1i`,e,a)}};return{methods:o.methods,props:o.props,__OLUM__:o,el:i,methodsRef:a,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Gs=e=>{let t=e||`PopoverTrigger`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.closest(`[data-slot="popover"]`),t=e&&e.querySelector(`:scope > input`),n=l.querySelector(`button`),r=()=>{t&&(t.checked=!t.checked,t.dispatchEvent(new Event(`change`,{bubbles:!0})))};return n.addEventListener(`click`,r),()=>n.removeEventListener(`click`,r)});let s=()=>q(n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`PopoverTrigger`,`j3whpqkpb0b`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`PopoverTrigger`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <button type="button" data-slot="popover-trigger" class="${olum.esc(s())}">${n.children}</button>`,olum.injectStyle(`PopoverTrigger`,f.__style__()),olum.handleMarkup(`PopoverTrigger`,`j3whpqkpb0b`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ks=e=>{let t=e||`PopoverContent`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.closest(`[data-slot="popover"]`),t=e&&e.querySelector(`:scope > input`),n=()=>{t&&(t.checked=!1,t.dispatchEvent(new Event(`change`,{bubbles:!0})))},r=t=>{e&&!e.contains(t.target)&&n()},i=e=>{e.key===`Escape`&&t&&t.checked&&n()};return document.addEventListener(`click`,r),document.addEventListener(`keydown`,i),()=>{document.removeEventListener(`click`,r),document.removeEventListener(`keydown`,i)}});let s=()=>q(`absolute top-full left-1/2 z-50 mt-1 w-72 -translate-x-1/2 flex-col gap-2.5 rounded-lg bg-background p-2.5 text-sm text-foreground shadow-md ring-1 ring-border outline-none`,n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`PopoverContent`,`olx6fbwyc3`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`PopoverContent`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <div data-slot="popover-content" class="${olum.esc(s())}">${n.children}</div>`,olum.injectStyle(`PopoverContent`,f.__style__()),olum.handleMarkup(`PopoverContent`,`olx6fbwyc3`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},qs=e=>{let t=e||`PopoverHeader`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`flex flex-col gap-0.5 text-sm`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`PopoverHeader`,`skcxdrtvsq`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`PopoverHeader`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="popover-header" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`PopoverHeader`,c.__style__()),olum.handleMarkup(`PopoverHeader`,`skcxdrtvsq`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Js=e=>{let t=e||`PopoverTitle`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`font-medium`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`PopoverTitle`,`qgsu5gvdzz`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`PopoverTitle`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="popover-title" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`PopoverTitle`,c.__style__()),olum.handleMarkup(`PopoverTitle`,`qgsu5gvdzz`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Ys=e=>{let t=e||`PopoverDescription`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`text-muted-foreground`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`PopoverDescription`,`e76scdkf4ri`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`PopoverDescription`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="popover-description" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`PopoverDescription`,c.__style__()),olum.handleMarkup(`PopoverDescription`,`e76scdkf4ri`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Xs=e=>{let t=e||`Sheet`,n=d(t),{defaultOpen:r=!1,children:i}=d(t);var a=olum.mkElm(`div`,`Sheet`,`lcr5f1ugytn`),o={},s={__style__(){return``},methods:{},props:{},compName:`Sheet`,deps:null,components:{},get getElm(){var e=a.isConnected?olum.vdom.mkStaging(a):a;return e.innerHTML=`
      <div data-slot="sheet" class="contents">
  <input type="checkbox" class="hidden" ${n.defaultOpen!==void 0&&n.defaultOpen?`checked`:``}>
  ${n.children}
</div>`,olum.injectStyle(`Sheet`,s.__style__()),olum.handleMarkup(`Sheet`,`lcr5f1ugytn`,e,o)}};return{methods:s.methods,props:s.props,__OLUM__:s,el:a,methodsRef:o,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},Zs=e=>{let t=e||`SheetTrigger`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.closest(`[data-slot="sheet"]`),t=e&&e.querySelector(`:scope > input`),n=l.querySelector(`button`),r=()=>{t&&(t.checked=!0,t.dispatchEvent(new Event(`change`,{bubbles:!0})))};return n.addEventListener(`click`,r),()=>n.removeEventListener(`click`,r)});let s=()=>q(n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`SheetTrigger`,`he1u7egohb8`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`SheetTrigger`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <button type="button" data-slot="sheet-trigger" class="${olum.esc(s())}">${n.children}</button>`,olum.injectStyle(`SheetTrigger`,f.__style__()),olum.handleMarkup(`SheetTrigger`,`he1u7egohb8`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},Qs=e=>{let t=e||`SheetContent`,n=d(t),{side:r=`right`,showCloseButton:i=!0,class:a=``,children:s}=d(t);var c=o(()=>{let e=m.closest(`[data-slot="sheet"]`),t=e&&e.querySelector(`:scope > input`),n=m.querySelector(`[data-slot="sheet-overlay"]`),r=m.querySelector(`[data-slot="sheet-content"]`),i=m.querySelector(`[data-builtin-close]`);if(!t||!n||!r)return;r.__olumModalInput=t;let a=()=>{t.checked=!1,t.dispatchEvent(new Event(`change`,{bubbles:!0}))},o=e=>{e.key===`Escape`&&t.checked&&a()},s=e=>{e.target===n&&a()},c=()=>{var e=t.checked?`open`:`closed`;n.setAttribute(`data-state`,e),r.setAttribute(`data-state`,e)};i&&i.addEventListener(`click`,a),n.addEventListener(`click`,s),document.addEventListener(`keydown`,o);let l=ko({input:t,nodes:[n,r],onOpen:c,onClose:c});return c(),()=>{i&&i.removeEventListener(`click`,a),n.removeEventListener(`click`,s),document.removeEventListener(`keydown`,o),l()}});let l=`z-50 flex flex-col gap-4 bg-background bg-clip-padding text-sm text-foreground shadow-lg fixed pointer-events-none transition-transform duration-300 ease-in-out data-[state=open]:pointer-events-auto [&>[data-olum]]:contents`,u={top:`inset-x-0 top-0 h-auto border-b -translate-y-full data-[state=open]:translate-y-0`,bottom:`inset-x-0 bottom-0 h-auto border-t translate-y-full data-[state=open]:translate-y-0`,left:`inset-y-0 left-0 h-full w-3/4 border-r sm:max-w-sm -translate-x-full data-[state=open]:translate-x-0`,right:`inset-y-0 right-0 h-full w-3/4 border-l sm:max-w-sm translate-x-full data-[state=open]:translate-x-0`},f=()=>q(l,u[n.side===void 0?`right`:n.side]||u.right,n.class===void 0?``:n.class);var p=olum.mkElm(`div`,`SheetContent`,`pge09hxq6si`),m=p,h={classes:f},g={__style__(){return``},methods:{},props:{},compName:`SheetContent`,deps:null,components:{},get getElm(){var e=p.isConnected?olum.vdom.mkStaging(p):p;return e.innerHTML=`
...
<div data-slot="sheet-content" data-side="${olum.esc(n.side===void 0?`right`:n.side)}" class="${olum.esc(f())}">
  ...
  `:``}
</div>`,olum.injectStyle(`SheetContent`,g.__style__()),olum.handleMarkup(`SheetContent`,`pge09hxq6si`,e,h)}};return{methods:g.methods,props:g.props,__OLUM__:g,el:p,methodsRef:h,stateProps:null,localsRef:{get base(){return l},get sides(){return u}},hooks:{mounted:c===void 0?null:c,unMounted:null,isMounted:!1,isUnMounted:!1}}},$s=e=>{let t=e||`SheetHeader`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`flex flex-col gap-0.5 p-4`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SheetHeader`,`0b30mymqn308`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`SheetHeader`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="sheet-header" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`SheetHeader`,c.__style__()),olum.handleMarkup(`SheetHeader`,`0b30mymqn308`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ec=e=>{let t=e||`SheetTitle`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`font-heading text-base font-medium text-foreground`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SheetTitle`,`15x6jol8rx3`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`SheetTitle`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="sheet-title" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`SheetTitle`,c.__style__()),olum.handleMarkup(`SheetTitle`,`15x6jol8rx3`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},tc=e=>{let t=e||`SheetDescription`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`text-sm text-muted-foreground`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SheetDescription`,`g13bkwcjrwf`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`SheetDescription`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="sheet-description" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`SheetDescription`,c.__style__()),olum.handleMarkup(`SheetDescription`,`g13bkwcjrwf`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},nc=e=>{let t=e||`SheetFooter`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`mt-auto flex flex-col gap-2 p-4`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`SheetFooter`,`d6k674o6625`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`SheetFooter`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
      <div data-slot="sheet-footer" class="${olum.esc(a())}">${n.children}</div>`,olum.injectStyle(`SheetFooter`,c.__style__()),olum.handleMarkup(`SheetFooter`,`d6k674o6625`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},rc=e=>{let t=e||`SheetClose`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.querySelector(`button`),t=()=>{let e=Oo(l,`sheet`,`sheet-content`);e&&(e.checked=!1,e.dispatchEvent(new Event(`change`,{bubbles:!0})))};return e.addEventListener(`click`,t),()=>e.removeEventListener(`click`,t)});let s=()=>q(n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`SheetClose`,`vli98x8rqto`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`SheetClose`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <button type="button" data-slot="sheet-close" class="${olum.esc(s())}">${n.children}</button>`,olum.injectStyle(`SheetClose`,f.__style__()),olum.handleMarkup(`SheetClose`,`vli98x8rqto`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},ic=e=>{let t=e||`Tooltip`,n=d(t),{children:r}=d(t);var i=olum.mkElm(`div`,`Tooltip`,`9z1x47qfb7`),a={},o={__style__(){return``},methods:{},props:{},compName:`Tooltip`,deps:null,components:{},get getElm(){var e=i.isConnected?olum.vdom.mkStaging(i):i;return e.innerHTML=`
  ...
  <input type="checkbox" class="hidden">
  ${n.children}
</div>`,olum.injectStyle(`Tooltip`,o.__style__()),olum.handleMarkup(`Tooltip`,`9z1x47qfb7`,e,a)}};return{methods:o.methods,props:o.props,__OLUM__:o,el:i,methodsRef:a,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},ac=e=>{let t=e||`TooltipProvider`,n=d(t),{children:r}=d(t);var i=olum.mkElm(`div`,`TooltipProvider`,`8n8gptb5kiu`),a={},o={__style__(){return``},methods:{},props:{},compName:`TooltipProvider`,deps:null,components:{},get getElm(){var e=i.isConnected?olum.vdom.mkStaging(i):i;return e.innerHTML=`
      <div data-slot="tooltip-provider" class="contents">${n.children}</div>`,olum.injectStyle(`TooltipProvider`,o.__style__()),olum.handleMarkup(`TooltipProvider`,`8n8gptb5kiu`,e,a)}};return{methods:o.methods,props:o.props,__OLUM__:o,el:i,methodsRef:a,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},oc=e=>{let t=e||`TooltipTrigger`,n=d(t),{class:r=``,children:i}=d(t);var a=o(()=>{let e=l.closest(`[data-slot="tooltip"]`),t=e&&e.querySelector(`:scope > input`),n=l.firstElementChild,r=e=>{t&&(t.checked=e,t.dispatchEvent(new Event(`change`,{bubbles:!0})))},i=()=>r(!0),a=()=>r(!1),o=()=>r(!0),s=()=>r(!1);return n.addEventListener(`mouseenter`,i),n.addEventListener(`mouseleave`,a),n.addEventListener(`focus`,o),n.addEventListener(`blur`,s),()=>{n.removeEventListener(`mouseenter`,i),n.removeEventListener(`mouseleave`,a),n.removeEventListener(`focus`,o),n.removeEventListener(`blur`,s)}});let s=()=>q(n.class===void 0?``:n.class);var c=olum.mkElm(`div`,`TooltipTrigger`,`3mcf2sk6x9y`),l=c,u={classes:s},f={__style__(){return``},methods:{},props:{},compName:`TooltipTrigger`,deps:null,components:{},get getElm(){var e=c.isConnected?olum.vdom.mkStaging(c):c;return e.innerHTML=`
      <span data-slot="tooltip-trigger" class="${olum.esc(s())}">${n.children}</span>`,olum.injectStyle(`TooltipTrigger`,f.__style__()),olum.handleMarkup(`TooltipTrigger`,`3mcf2sk6x9y`,e,u)}};return{methods:f.methods,props:f.props,__OLUM__:f,el:c,methodsRef:u,stateProps:null,localsRef:{},hooks:{mounted:a===void 0?null:a,unMounted:null,isMounted:!1,isUnMounted:!1}}},sc=e=>{let t=e||`TooltipContent`,n=d(t),{class:r=``,children:i}=d(t),a=()=>q(`absolute bottom-full left-1/2 z-50 mb-1.5 inline-flex w-fit max-w-xs -translate-x-1/2 items-center gap-1.5 rounded-md bg-foreground px-3 py-1.5 text-xs text-background whitespace-nowrap transition-[opacity,transform] duration-300 ease-out`,n.class===void 0?``:n.class);var o=olum.mkElm(`div`,`TooltipContent`,`lq7zqmb8owm`),s={classes:a},c={__style__(){return``},methods:{},props:{},compName:`TooltipContent`,deps:null,components:{},get getElm(){var e=o.isConnected?olum.vdom.mkStaging(o):o;return e.innerHTML=`
...
</div>`,olum.injectStyle(`TooltipContent`,c.__style__()),olum.handleMarkup(`TooltipContent`,`lq7zqmb8owm`,e,s)}};return{methods:c.methods,props:c.props,__OLUM__:c,el:o,methodsRef:s,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},cc=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg>`,lc=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><rect width="8" height="4" x="8" y="2" rx="1" ry="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/></svg>`,uc=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><circle cx="6" cy="6" r="3"/><path d="M8.12 8.12 12 12m8-8L8.12 15.88"/><circle cx="6" cy="18" r="3"/><path d="M14.8 14.8 20 20"/></svg>`,dc=e=>{let t=e||`page`,n=()=>console.log(`deleted`);var r=olum.mkElm(`div`,`page`,`0ykso5unjztk`),i={confirmDelete:n},a={__style__(){return``},methods:{},props:{},compName:`page`,deps:null,components:{Nav:X,FeatureSidebar:Z,SiteFooter:Q,Icon:Y,Button:J,Avatar:tr,AvatarFallback:nr,AlertDialog:os,AlertDialogTrigger:ss,AlertDialogContent:cs,AlertDialogHeader:ls,AlertDialogTitle:us,AlertDialogDescription:ds,AlertDialogFooter:fs,AlertDialogCancel:ps,AlertDialogAction:ms,ContextMenu:hs,ContextMenuTrigger:gs,ContextMenuContent:_s,DropdownMenuItem:Fo,DropdownMenu:Pr,DropdownMenuSeparator:Io,Dialog:vs,DialogTrigger:ys,DialogContent:bs,DialogHeader:xs,DialogTitle:Ss,DialogDescription:Cs,DialogFooter:ws,DialogClose:Ts,Drawer:Es,DrawerTrigger:Ds,DrawerContent:Os,DrawerHeader:ks,DrawerTitle:As,DrawerDescription:js,DrawerFooter:Ms,DrawerClose:Ns,DropdownMenuTrigger:Fr,DropdownMenuContent:Ir,DropdownMenuLabel:Ps,DropdownMenuGroup:Fs,DropdownMenuCheckboxItem:Lr,DropdownMenuRadioGroup:Is,DropdownMenuRadioItem:Ls,DropdownMenuSub:Rs,DropdownMenuSubTrigger:zs,DropdownMenuSubContent:Bs,HoverCard:Vs,HoverCardTrigger:Hs,HoverCardContent:Us,Popover:Ws,PopoverTrigger:Gs,PopoverContent:Ks,PopoverHeader:qs,PopoverTitle:Js,PopoverDescription:Ys,Sheet:Xs,SheetTrigger:Zs,SheetContent:Qs,SheetHeader:$s,SheetTitle:ec,SheetDescription:tc,SheetFooter:nc,SheetClose:rc,Tooltip:ic,TooltipProvider:ac,TooltipTrigger:oc,TooltipContent:sc},get getElm(){var e=r.isConnected?olum.vdom.mkStaging(r):r;return e.innerHTML=`
      <olum name="Nav"></olum>
    ...
    <div class="rounded-xl border border-border p-6">
      ...
      <olum name="ContextMenu">
        ...
        <olum name="ContextMenuContent">
          ...
          <olum name="DropdownMenuItem"><olum name="Icon" data-o-props='${encodeURIComponent(JSON.stringify({icon:lc,class:`size-4`})).replace(/'/g,`%27`)}'></olum><span>Paste</span></olum>
          <olum name="DropdownMenuItem"><olum name="Icon" data-o-props='${encodeURIComponent(JSON.stringify({icon:uc,class:`size-4`})).replace(/'/g,`%27`)}'></olum><span>Cut</span></olum>
          <olum name="DropdownMenuSeparator"></olum>
    ...
    <div class="rounded-xl border border-border p-6">
      ...
      <olum name="DropdownMenu">
        <olum name="DropdownMenuTrigger">
          <olum name="Button" data-o-props='${encodeURIComponent(JSON.stringify({variant:`outline`,size:`icon`,ariaLabel:`Open menu`})).replace(/'/g,`%27`)}'><olum name="Icon" data-o-props='${encodeURIComponent(JSON.stringify({icon:cc,class:`size-4`})).replace(/'/g,`%27`)}'></olum></olum>
        </olum>
        <olum name="DropdownMenuContent">
          ...
          <olum name="DropdownMenuSub">
            <olum name="DropdownMenuSubTrigger"><olum name="Icon" data-o-props='${encodeURIComponent(JSON.stringify({icon:to,class:`size-4`})).replace(/'/g,`%27`)}'></olum><span>More tools</span></olum>
      ...
      <olum name="TooltipProvider">
        <olum name="Tooltip">
          <olum name="TooltipTrigger">
            <olum name="Button" data-o-props='${encodeURIComponent(JSON.stringify({variant:`outline`,size:`icon`,ariaLabel:`Settings`})).replace(/'/g,`%27`)}'><olum name="Icon" data-o-props='${encodeURIComponent(JSON.stringify({icon:to,class:`size-4`})).replace(/'/g,`%27`)}'></olum></olum>
          </olum>
...
<olum name="SiteFooter"></olum>`,olum.injectStyle(`page`,a.__style__()),olum.handleMarkup(`page`,`0ykso5unjztk`,e,i)}};return{methods:a.methods,props:a.props,__OLUM__:a,el:r,methodsRef:i,stateProps:null,localsRef:{},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}},fc=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M10 5H3m9 14H3M14 3v4m2 10v4m5-9h-9m9 7h-5m5-14h-7m-6 5v4m0-2H3"/></svg>`,pc=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18M9 21V9"/></svg>`,mc=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="m16.24 7.76-1.804 5.411a2 2 0 0 1-1.265 1.265L7.76 16.24l1.804-5.411a2 2 0 0 1 1.265-1.265z"/></svg>`,hc=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M10.268 21a2 2 0 0 0 3.464 0m-10.47-5.674A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326"/></svg>`,gc=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M9 3H5a2 2 0 0 0-2 2v4m6-6h10a2 2 0 0 1 2 2v4M9 3v18m0 0h10a2 2 0 0 0 2-2V9M9 21H5a2 2 0 0 1-2-2V9m0 0h18"/></svg>`,_c=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="14" y="14" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/></svg>`,vc=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M12 19h8M4 17l6-6-6-6"/></svg>`,yc=`<svg xmlns="http://www.w3.org/2000/svg" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497zM15 5l4 4"/></svg>`,bc=new m({mode:`history`,root:`/`,err:`/404`,routes:[{path:`/`,comp:vn},{path:`/binding`,comp:Tt},{path:`/blog/:slug`,comp:kt},{path:`/blog`,comp:zt},{path:`/composition`,comp:Jt},{path:`/control-flow`,comp:$t},{path:`/lifecycle`,comp:on},{path:`/reactivity`,comp:wn},{path:`/store`,comp:Ln},{path:`/transitions`,comp:Hn},{path:`/ui/data-display`,comp:bi},{path:`/ui/feedback`,comp:Ri},{path:`/ui/forms`,comp:Na},{path:`/ui/layout`,comp:ro},{path:`/ui/navigation`,comp:as},{path:`/ui/overlay`,comp:dc},{path:`/ui`,comp:e=>{let t=[{to:`/ui/forms`,icon:fc,title:`Forms`,desc:`Input, Select, Checkbox, Slider, Field, OTP, and every other data-entry component.`},{to:`/ui/layout`,icon:pc,title:`Layout`,desc:`Card, Sidebar, Resizable, ScrollArea, AspectRatio, Separator, Direction.`},{to:`/ui/navigation`,icon:mc,title:`Navigation`,desc:`Tabs, Breadcrumb, Pagination, Command, Menubar, NavigationMenu, Anchor.`},{to:`/ui/overlay`,icon:wt,title:`Overlay`,desc:`Dialog, Drawer, Sheet, Popover, Tooltip, HoverCard, DropdownMenu, ContextMenu, AlertDialog.`},{to:`/ui/feedback`,icon:hc,title:`Feedback`,desc:`Alert, Empty, Progress, Skeleton, Spinner, Toast.`},{to:`/ui/data-display`,icon:gc,title:`Data Display`,desc:`Table, DataTable, Chart, Accordion, Avatar, Carousel, Message, and more.`}],n=[{icon:_c,title:`58 Components`,desc:`Every primitive you need, from Button to DataTable.`},{icon:hn,title:`6 Categories`,desc:`Forms, Layout, Navigation, Overlay, Feedback, Data Display.`},{icon:vc,title:`One Command`,desc:`olum add <name> installs a component's source into your project.`},{icon:yc,title:`Yours to Edit`,desc:`Installed components are plain .html files you own, not a black box.`}];var r=olum.mkElm(`div`,`page`,`lnac6ltcno7`),i={},a={__style__(){return``},methods:{},props:{},compName:`page`,deps:null,components:{Nav:X,FeatureSidebar:Z,SiteFooter:Q,PageHero:lt,WhyYoullLoveIt:gt,FeaturePager:vt,Icon:Y,Card:At,CardHeader:jt,CardTitle:Mt,CardDescription:Nt,CardFooter:ln},get getElm(){var e=r.isConnected?olum.vdom.mkStaging(r):r;return e.innerHTML=`
      <olum name="Nav"></olum>
...
<olum name="SiteFooter"></olum>`,olum.injectStyle(`page`,a.__style__()),olum.handleMarkup(`page`,`lnac6ltcno7`,e,i)}};return{methods:a.methods,props:a.props,__OLUM__:a,el:r,methodsRef:i,stateProps:null,localsRef:{get categories(){return t},get loveItems(){return n}},hooks:{mounted:typeof mounted<`u`?mounted:null,unMounted:null,isMounted:!1,isUnMounted:!1}}}},{path:`/404`,comp:cn}]});new a().$(`#app`).use(bc);